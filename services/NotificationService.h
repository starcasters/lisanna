...
#define SERVICE_NotificationService_NAME "bnet.protocol.notification.NotificationService"
...
public:
	...
	CServiceNotificationService(CServiceMgr* owner,int SID, std::string sName);
