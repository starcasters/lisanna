...
CServiceUserManagerNotify::CServiceUserManagerNotify()
{
...
Message* CServiceUserManagerNotify::GetMethodMessage(int MethodID, bool request) {
	switch (MethodID) {
		case 1:
			if (request) { return ::bnet::protocol::user_manager::BlockedPlayerNotification::default_instance().New(); }
...
bool CServiceUserManagerNotify::DispatchMethod(int MethodID, bool request, TCPSocket *sock, apacket* packet) {
	switch (MethodID) {
		case 1:
			if (request) { return handle_NotifyPlayerBlocked_Request(sock, packet); }
			else {cerr << "error: method has no response data" << endl; }
		case 2:
			if (request) { return handle_NotifyPlayerBlockRemoved_Request(sock, packet); }
			else {cerr << "error: method has no response data" << endl; }
...
bool CServiceUserManagerNotify::handle_NotifyPlayerBlocked_Request(TCPSocket *sock, apacket* packet)
{
	::bnet::protocol::user_manager::BlockedPlayerNotification* request;
...
bool CServiceUserManagerNotify::handle_NotifyPlayerBlockRemoved_Request(TCPSocket *sock, apacket* packet)
{
	::bnet::protocol::user_manager::BlockedPlayerNotification* request;
		//this packet has no response asociated.
	// do something...
...
CServiceUserManagerNotify::~CServiceUserManagerNotify(void)
{
