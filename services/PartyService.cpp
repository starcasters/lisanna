...
CServicePartyService::CServicePartyService()
{
...
bool CServicePartyService::DispatchMethod(int MethodID, bool request, TCPSocket *sock, apacket* packet) {
	switch (MethodID) {
		case 1:
...
bool CServicePartyService::handle_CreateChannel_Request(TCPSocket *sock, apacket* packet)
{
...
bool CServicePartyService::handle_CreateChannel_Response(TCPSocket *sock, apacket* packet)
...
bool CServicePartyService::handle_JoinChannel_Request(TCPSocket *sock, apacket* packet)
{
...
bool CServicePartyService::handle_JoinChannel_Response(TCPSocket *sock, apacket* packet)
...
bool CServicePartyService::handle_GetChannelInfo_Request(TCPSocket *sock, apacket* packet)
{
...
bool CServicePartyService::handle_GetChannelInfo_Response(TCPSocket *sock, apacket* packet)
...
CServicePartyService::~CServicePartyService(void)
{
