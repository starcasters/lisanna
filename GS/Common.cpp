...
PRTransform::PRTransform() {
		...
		Fields[0].fieldinfo(&aQuaternion, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aVector3D, 16, 0, 0, 0, 0, 1, &aDT_NULL, -1);
...
PRSTransform::PRSTransform() {
		...
		Fields[0].fieldinfo(&aQuaternion, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aVector3D, 16, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
...
RGBAColor::RGBAColor() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_BYTE, 0, 8, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_BYTE, 1, 8, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_BYTE, 2, 8, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_BYTE, 3, 8, 0, 0, 0, 1, &aDT_NULL, -1);
...
SerializeData::SerializeData() {
		...
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SerializeData::~SerializeData() {
		free(Fields);
...
AABB::AABB() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aVector3D, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aVector3D, 12, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AABB::~AABB() {
		free(Fields);
...
OBB::OBB() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aPRTransform, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aVector3D, 28, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
OBB::~OBB() {
		free(Fields);
...
Circle::Circle() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aVector2D, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
...
Sphere::Sphere() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aVector3D, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_FLOAT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Sphere::~Sphere() {
		free(Fields);
...
Quaternion::Quaternion() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_FLOAT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aVector3D, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Quaternion::~Quaternion() {
		free(Fields);
...
Quaternion16::Quaternion16() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 5);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_WORD, 0, 16, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_WORD, 2, 16, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_WORD, 4, 16, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_WORD, 6, 16, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Quaternion16::~Quaternion16() {
		free(Fields);
...
AxialCylinder::AxialCylinder() {
		...
		Fields[0].fieldinfo(&aVector3D, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_FLOAT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AxialCylinder::~AxialCylinder() {
		free(Fields);
...
Cylinder::Cylinder() {
		...
		Fields[0].fieldinfo(&aVector3D, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aVector3D, 12, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Cylinder::~Cylinder() {
		free(Fields);
...
LineSeg3D::LineSeg3D() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aRay3D, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_FLOAT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
LineSeg3D::~LineSeg3D() {
		free(Fields);
...
Matrix3x3::Matrix3x3() {
		...
		Fields[2].fieldinfo(&aDT_FLOAT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FLOAT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FLOAT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FLOAT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_FLOAT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
...
Matrix4x4::Matrix4x4() {
		...
		Fields[7].fieldinfo(&aDT_FLOAT, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_FLOAT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLOAT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 44, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_FLOAT, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_FLOAT, 52, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_FLOAT, 56, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_FLOAT, 60, 32, 0, 0, 0, 1, &aDT_NULL, -1);
...
ConstraintParameters::ConstraintParameters() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[1].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 72, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 76, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aPRTransform, 80, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aVector3D, 108, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aPRTransform, 120, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aPRTransform, 148, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 176, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLOAT, 180, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 184, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_FLOAT, 188, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_FLOAT, 192, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_FLOAT, 196, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_FLOAT, 200, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_FLOAT, 204, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_FLOAT, 208, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_CHARARRAY, 212, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[20 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ConstraintParameters::~ConstraintParameters() {
		free(Fields);
}
...
OctreeNode::OctreeNode() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aOctreeCube, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_FIXEDARRAY, 16, 32, 0, 0, 0, 1, &aDT_INT, 8);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
OctreeNode::~OctreeNode() {
		free(Fields);
...
OctreeLeaf::OctreeLeaf() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aOctreeCube, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
...
Octree::Octree() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aSerializeData, 24, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_VARIABLEARRAY, 32, 0, 0, 0, 0, 32, &aOctreeNode, -1);
		Fields[8].fieldinfo(&aSerializeData, 40, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_VARIABLEARRAY, 48, 0, 0, 0, 0, 32, &aOctreeLeaf, -1);
		Fields[10].fieldinfo(&aSerializeData, 56, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_VARIABLEARRAY, 64, 0, 0, 0, 0, 32, &aOctreePrimitive, -1);
...
Shape::Shape() {
		...
		Fields[5].fieldinfo(&aDT_FLOAT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FLOAT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aConvexHull, 28, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aOBB, 132, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aSphere, 172, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aCylinder, 188, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aCapsule, 216, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Shape::~Shape() {
		free(Fields);
...
Triangle3D::Triangle3D() {
		...
		Fields[0].fieldinfo(&aVector3D, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aVector3D, 12, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aVector3D, 24, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Triangle3D::~Triangle3D() {
		free(Fields);
...
ConvexHull::ConvexHull() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 4, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 12, 0, 0, 0, 0, 1, &aVector3D, -1);
		Fields[3].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSerializeData, 20, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 1, &aIndexedTriangle, -1);
		Fields[6].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aSerializeData, 36, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_VARIABLEARRAY, 44, 0, 0, 0, 0, 1, &aPlane, -1);
		Fields[9].fieldinfo(&aMatrix3x3, 48, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aVector3D, 84, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 96, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_FLOAT, 100, 32, 0, 0, 0, 1, &aDT_NULL, -1);
...
SNOEntry::SNOEntry() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_SNO_GROUP, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_CHARARRAY, 8, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SNOEntry::~SNOEntry() {
		free(Fields);
...
GameSyncedData::GameSyncedData() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 1, 0, 0, 1, 17, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 52, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 56, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 60, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FIXEDARRAY, 72, 32, 0, 0, 0, 1, &aDT_INT, 2);
		Fields[7].fieldinfo(&aDT_FIXEDARRAY, 80, 32, 0, 0, 0, 1, &aDT_INT, 2);
...
EntityId::EntityId() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT64, 0, 64, 0, 0, 0, 1, &aDT_NULL, -1);
...
AttributeSpecifier::AttributeSpecifier() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 5);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_TRANSLATEABLE, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_SNO, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aSerializeData, 16, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FORMULA, 8, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AttributeSpecifier::~AttributeSpecifier() {
		free(Fields);
...
GBHandle::GBHandle() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 6, 0, -2, 37, 17, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
GBHandle::~GBHandle() {
...
Item::Item() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 4, 9, 0, 0, 0, 5, &aDT_NULL, 256);
		Fields[1].fieldinfo(&aDT_SNO, 260, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_GBID, 264, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 276, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_ENUM, 280, 10, 0, -1, 1000, 17, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 284, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_INT, 288, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 292, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 296, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_INT, 300, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_INT, 312, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_INT, 316, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_INT, 304, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_INT, 308, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_GBID, 320, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_GBID, 324, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_SNO, 328, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_SNO, 332, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_SNO, 336, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_SNO, 340, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_SNO, 344, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aDT_INT, 272, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[29].fieldinfo(&aDT_FLOAT, 452, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[30].fieldinfo(&aDT_FLOAT, 456, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[31].fieldinfo(&aDT_FLOAT, 720, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[32].fieldinfo(&aDT_FLOAT, 544, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[33].fieldinfo(&aDT_FLOAT, 548, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[34].fieldinfo(&aDT_SNO, 916, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[35].fieldinfo(&aDT_INT, 920, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[36].fieldinfo(&aDT_SNO, 924, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[37].fieldinfo(&aDT_INT, 928, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[38].fieldinfo(&aDT_SNO, 932, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[39].fieldinfo(&aDT_INT, 936, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[40].fieldinfo(&aDT_SNO, 940, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[41].fieldinfo(&aDT_INT, 944, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[42].fieldinfo(&aDT_FIXEDARRAY, 348, 32, 0, 0, 0, 1, &aDT_INT, 4);
		Fields[43].fieldinfo(&aDT_TRANSLATEABLE, 992, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[44].fieldinfo(&aDT_ATTRIBUTEPARAM, 996, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[45].fieldinfo(&aSerializeData, 1008, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[46].fieldinfo(&aDT_FORMULA, 1000, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[47].fieldinfo(&aDT_TRANSLATEABLE, 1016, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[48].fieldinfo(&aDT_ATTRIBUTEPARAM, 1020, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[49].fieldinfo(&aSerializeData, 1032, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[50].fieldinfo(&aDT_FORMULA, 1024, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[51].fieldinfo(&aDT_TRANSLATEABLE, 1040, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[52].fieldinfo(&aDT_ATTRIBUTEPARAM, 1044, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[53].fieldinfo(&aSerializeData, 1056, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[54].fieldinfo(&aDT_FORMULA, 1048, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[55].fieldinfo(&aDT_TRANSLATEABLE, 1064, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[56].fieldinfo(&aDT_ATTRIBUTEPARAM, 1068, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[57].fieldinfo(&aSerializeData, 1080, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[58].fieldinfo(&aDT_FORMULA, 1072, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[59].fieldinfo(&aDT_TRANSLATEABLE, 1088, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[60].fieldinfo(&aDT_ATTRIBUTEPARAM, 1092, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[61].fieldinfo(&aSerializeData, 1104, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[62].fieldinfo(&aDT_FORMULA, 1096, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[63].fieldinfo(&aDT_TRANSLATEABLE, 1112, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[64].fieldinfo(&aDT_ATTRIBUTEPARAM, 1116, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[65].fieldinfo(&aSerializeData, 1128, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[66].fieldinfo(&aDT_FORMULA, 1120, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[67].fieldinfo(&aDT_TRANSLATEABLE, 1136, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[68].fieldinfo(&aDT_ATTRIBUTEPARAM, 1140, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[69].fieldinfo(&aSerializeData, 1152, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[70].fieldinfo(&aDT_FORMULA, 1144, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[71].fieldinfo(&aDT_TRANSLATEABLE, 1160, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[72].fieldinfo(&aDT_ATTRIBUTEPARAM, 1164, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[73].fieldinfo(&aSerializeData, 1176, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[74].fieldinfo(&aDT_FORMULA, 1168, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[75].fieldinfo(&aDT_TRANSLATEABLE, 1184, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[76].fieldinfo(&aDT_ATTRIBUTEPARAM, 1188, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[77].fieldinfo(&aSerializeData, 1200, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[78].fieldinfo(&aDT_FORMULA, 1192, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[79].fieldinfo(&aDT_TRANSLATEABLE, 1208, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[80].fieldinfo(&aDT_ATTRIBUTEPARAM, 1212, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[81].fieldinfo(&aSerializeData, 1224, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[82].fieldinfo(&aDT_FORMULA, 1216, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[83].fieldinfo(&aDT_TRANSLATEABLE, 1232, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[84].fieldinfo(&aDT_ATTRIBUTEPARAM, 1236, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[85].fieldinfo(&aSerializeData, 1248, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[86].fieldinfo(&aDT_FORMULA, 1240, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[87].fieldinfo(&aDT_TRANSLATEABLE, 1256, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[88].fieldinfo(&aDT_ATTRIBUTEPARAM, 1260, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[89].fieldinfo(&aSerializeData, 1272, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[90].fieldinfo(&aDT_FORMULA, 1264, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[91].fieldinfo(&aDT_TRANSLATEABLE, 1280, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[92].fieldinfo(&aDT_ATTRIBUTEPARAM, 1284, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[93].fieldinfo(&aSerializeData, 1296, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[94].fieldinfo(&aDT_FORMULA, 1288, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[95].fieldinfo(&aDT_TRANSLATEABLE, 1304, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[96].fieldinfo(&aDT_ATTRIBUTEPARAM, 1308, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[97].fieldinfo(&aSerializeData, 1320, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[98].fieldinfo(&aDT_FORMULA, 1312, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[99].fieldinfo(&aDT_TRANSLATEABLE, 1328, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[100].fieldinfo(&aDT_ATTRIBUTEPARAM, 1332, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[101].fieldinfo(&aSerializeData, 1344, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[102].fieldinfo(&aDT_FORMULA, 1336, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[103].fieldinfo(&aDT_TRANSLATEABLE, 1352, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[104].fieldinfo(&aDT_ATTRIBUTEPARAM, 1356, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[105].fieldinfo(&aSerializeData, 1368, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[106].fieldinfo(&aDT_FORMULA, 1360, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[107].fieldinfo(&aDT_ENUM, 1376, 4, 0, -1, 10, 17, &aDT_NULL, -1);
		Fields[108].fieldinfo(&aDT_FIXEDARRAY, 1380, 32, 0, 0, 0, 1, &aDT_GBID, 6);
		Fields[109].fieldinfo(&aDT_GBID, 1404, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[110].fieldinfo(&aDT_GBID, 1408, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[111].fieldinfo(&aDT_GBID, 1412, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[112].fieldinfo(&aDT_GBID, 1416, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[113].fieldinfo(&aDT_GBID, 1420, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[114].fieldinfo(&aDT_GBID, 1424, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[115].fieldinfo(&aDT_GBID, 1428, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[116].fieldinfo(&aDT_INT, 1432, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[117].fieldinfo(&aDT_INT, 1436, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[118].fieldinfo(&aDT_INT, 1440, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[119].fieldinfo(&aDT_INT, 1444, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[120].fieldinfo(&aDT_INT, 1448, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[121].fieldinfo(&aDT_INT, 1452, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[123 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Item::~Item() {
		free(Fields);
}
...
Items::Items() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aItem, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Items::~Items() {
		free(Fields);
...
ItemType::ItemType() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 4, 9, 0, 0, 0, 5, &aDT_NULL, 256);
		Fields[1].fieldinfo(&aDT_GBID, 260, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 264, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_ENUM, 272, 5, 0, 0, 28, 17, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_ENUM, 276, 5, 0, 0, 28, 17, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_ENUM, 280, 5, 0, 0, 28, 17, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_ENUM, 284, 5, 0, 0, 28, 17, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_FLAG, 268, 1, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_GBID, 288, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_GBID, 292, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_GBID, 296, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_GBID, 300, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_FIXEDARRAY, 304, 32, 0, 0, 0, 1, &aDT_INT, 4);
		Fields[24 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ItemType::~ItemType() {
		free(Fields);
}
...
Items_1::Items_1() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aItemType, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Items_1::~Items_1() {
		free(Fields);
...
RecipeIngredient::RecipeIngredient() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_GBID, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
RecipeIngredient::~RecipeIngredient() {
...
ItemEnhancement::ItemEnhancement() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 4, 9, 0, 0, 0, 5, &aDT_NULL, 256);
		Fields[1].fieldinfo(&aDT_INT, 260, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 264, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 268, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 272, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FIXEDARRAY, 280, 0, 0, 0, 0, 1, &aAttributeSpecifier, 16);
		Fields[6].fieldinfo(&aDT_INT, 664, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FIXEDARRAY, 668, 0, 0, 0, 0, 1, &aRecipeIngredient, 3);
		Fields[9 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ItemEnhancement::~ItemEnhancement() {
		free(Fields);
...
ItemEnhancementTable::ItemEnhancementTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aItemEnhancement, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ItemEnhancementTable::~ItemEnhancementTable() {
		free(Fields);
...
ExperienceLevel::ExperienceLevel() {
		...
		Fields[2].fieldinfo(&aDT_FLOAT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FLOAT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_INT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_INT, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_INT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_INT, 44, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_INT, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_INT, 52, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_INT, 56, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_INT, 60, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_INT, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_INT, 72, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_FLOAT, 76, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_INT, 80, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_INT, 84, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_INT, 88, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_INT, 92, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aDT_INT, 96, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aDT_INT, 100, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aDT_INT, 104, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aDT_INT, 108, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aDT_INT, 112, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[29].fieldinfo(&aDT_INT, 116, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[30].fieldinfo(&aDT_INT, 120, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[31].fieldinfo(&aDT_INT, 124, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[32].fieldinfo(&aDT_INT, 128, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[33].fieldinfo(&aDT_INT, 132, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[34].fieldinfo(&aDT_INT, 136, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[35].fieldinfo(&aDT_INT, 140, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[36].fieldinfo(&aDT_INT, 144, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[37].fieldinfo(&aDT_INT, 148, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[38].fieldinfo(&aDT_INT, 152, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[39].fieldinfo(&aDT_INT, 156, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[40].fieldinfo(&aDT_INT, 176, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[41].fieldinfo(&aDT_INT, 180, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[42].fieldinfo(&aDT_INT, 184, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[43].fieldinfo(&aDT_INT, 188, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[44].fieldinfo(&aDT_INT, 192, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[45].fieldinfo(&aDT_INT, 196, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[46].fieldinfo(&aDT_INT, 200, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[47].fieldinfo(&aDT_INT, 204, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[48].fieldinfo(&aDT_INT, 208, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[49].fieldinfo(&aDT_INT, 212, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[50].fieldinfo(&aDT_INT, 216, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[51].fieldinfo(&aDT_INT, 220, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[53 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ExperienceLevel::~ExperienceLevel() {
		free(Fields);
}
...
ExperienceTable::ExperienceTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aExperienceLevel, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ExperienceTable::~ExperienceTable() {
		free(Fields);
...
PowerFormulaTableEntry::PowerFormulaTableEntry() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 11, 0, 0, 0, 1, &aDT_NULL, 1024);
		Fields[1].fieldinfo(&aDT_FLOAT, 1024, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 1028, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FLOAT, 1032, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 1036, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FLOAT, 1040, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FLOAT, 1044, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 1048, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_FLOAT, 1052, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 1056, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLOAT, 1060, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 1064, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_FLOAT, 1068, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_FLOAT, 1072, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_FLOAT, 1076, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_FLOAT, 1080, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_FLOAT, 1084, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_FLOAT, 1088, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_FLOAT, 1092, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_FLOAT, 1096, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_FLOAT, 1100, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_FLOAT, 1104, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_FLOAT, 1108, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_FLOAT, 1112, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aDT_FLOAT, 1116, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aDT_FLOAT, 1120, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aDT_FLOAT, 1124, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aDT_FLOAT, 1128, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aDT_FLOAT, 1132, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[29].fieldinfo(&aDT_FLOAT, 1136, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[30].fieldinfo(&aDT_FLOAT, 1140, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[31].fieldinfo(&aDT_FLOAT, 1144, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[32].fieldinfo(&aDT_FLOAT, 1148, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[33].fieldinfo(&aDT_FLOAT, 1152, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[34].fieldinfo(&aDT_FLOAT, 1156, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[35].fieldinfo(&aDT_FLOAT, 1160, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[36].fieldinfo(&aDT_FLOAT, 1164, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[37].fieldinfo(&aDT_FLOAT, 1168, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[38].fieldinfo(&aDT_FLOAT, 1172, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[39].fieldinfo(&aDT_FLOAT, 1176, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[40].fieldinfo(&aDT_FLOAT, 1180, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[41].fieldinfo(&aDT_FLOAT, 1184, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[42].fieldinfo(&aDT_FLOAT, 1188, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[43].fieldinfo(&aDT_FLOAT, 1192, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[44].fieldinfo(&aDT_FLOAT, 1196, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[45].fieldinfo(&aDT_FLOAT, 1200, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[46].fieldinfo(&aDT_FLOAT, 1204, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[47].fieldinfo(&aDT_FLOAT, 1208, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[48].fieldinfo(&aDT_FLOAT, 1212, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[49].fieldinfo(&aDT_FLOAT, 1216, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[50].fieldinfo(&aDT_FLOAT, 1220, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[51].fieldinfo(&aDT_FLOAT, 1224, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[52].fieldinfo(&aDT_FLOAT, 1228, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[53].fieldinfo(&aDT_FLOAT, 1232, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[54].fieldinfo(&aDT_FLOAT, 1236, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[55].fieldinfo(&aDT_FLOAT, 1240, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[56].fieldinfo(&aDT_FLOAT, 1244, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[57].fieldinfo(&aDT_FLOAT, 1248, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[58].fieldinfo(&aDT_FLOAT, 1252, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[59].fieldinfo(&aDT_FLOAT, 1256, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[60].fieldinfo(&aDT_FLOAT, 1260, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[61].fieldinfo(&aDT_FLOAT, 1264, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[63 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
PowerFormulaTableEntry::~PowerFormulaTableEntry() {
		free(Fields);
}
...
PowerFormulaTable::PowerFormulaTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aPowerFormulaTableEntry, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
PowerFormulaTable::~PowerFormulaTable() {
		free(Fields);
...
HelpCodes::HelpCodes() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 256, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[2].fieldinfo(&aDT_CHARARRAY, 512, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
HelpCodes::~HelpCodes() {
		free(Fields);
...
HelpCodes_1::HelpCodes_1() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aHelpCodes, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
HelpCodes_1::~HelpCodes_1() {
		free(Fields);
...
ItemTierData::ItemTierData() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_GBID, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_GBID, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_GBID, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_GBID, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_GBID, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_GBID, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_GBID, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_GBID, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ItemTierData::~ItemTierData() {
		free(Fields);
...
ItemTiers::ItemTiers() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aItemTierData, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ItemTiers::~ItemTiers() {
		free(Fields);
...
LootDistribution::LootDistribution() {
		...
		Fields[14].fieldinfo(&aDT_FLOAT, 56, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_FLOAT, 60, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_FLOAT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_FLOAT, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_FLOAT, 72, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_FLOAT, 76, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_FLOAT, 80, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_INT, 84, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_INT, 88, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
...
LootDistributionTable::LootDistributionTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aLootDistribution, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
LootDistributionTable::~LootDistributionTable() {
		free(Fields);
...
LootDistribution_1::LootDistribution_1() {
		...
		Fields[17].fieldinfo(&aDT_INT, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_INT, 72, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_INT, 76, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_INT, 80, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_INT, 84, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_INT, 88, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
...
ItemLevelModTable::ItemLevelModTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aLootDistribution_1, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ItemLevelModTable::~ItemLevelModTable() {
		free(Fields);
...
QualityClass::QualityClass() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 4, 9, 0, 0, 0, 5, &aDT_NULL, 256);
		Fields[1].fieldinfo(&aDT_FLOAT, 264, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 268, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FLOAT, 272, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 276, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FLOAT, 280, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FLOAT, 284, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 288, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_FLOAT, 292, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 296, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLOAT, 300, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 304, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_FLOAT, 308, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_FLOAT, 312, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_FLOAT, 316, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_FLOAT, 320, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_FLOAT, 324, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_FLOAT, 328, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_FLOAT, 332, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_FLOAT, 336, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_FLOAT, 340, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_FLOAT, 344, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_FLOAT, 348, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
QualityClass::~QualityClass() {
		free(Fields);
...
QualityClassTable::QualityClassTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aQualityClass, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
QualityClassTable::~QualityClassTable() {
		free(Fields);
...
HeroData::HeroData() {
		...
		Fields[0].fieldinfo(&aDT_CHARARRAY, 4, 9, 0, 0, 0, 5, &aDT_NULL, 256);
		Fields[1].fieldinfo(&aDT_SNO, 260, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_SNO, 264, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_SNO, 268, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 272, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_SNO, 276, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_SNO, 280, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_SNO, 284, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_SNO, 288, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_SNO, 292, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_SNO, 296, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 308, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_INT, 312, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_FLOAT, 796, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_FLOAT, 800, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_FLOAT, 808, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_FLOAT, 804, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_FLOAT, 332, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_FLOAT, 336, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_FLOAT, 348, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_ENUM, 300, 3, 0, 0, 6, 17, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_ENUM, 304, 3, 0, 0, 6, 17, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_FLOAT, 352, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_FLOAT, 356, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aDT_FLOAT, 360, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aDT_FLOAT, 368, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aDT_FLOAT, 372, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aDT_FLOAT, 376, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aDT_FLOAT, 496, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[29].fieldinfo(&aDT_FLOAT, 404, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[30].fieldinfo(&aDT_FLOAT, 532, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[31].fieldinfo(&aDT_FLOAT, 536, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[32].fieldinfo(&aDT_FLOAT, 488, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[33].fieldinfo(&aDT_FLOAT, 544, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[34].fieldinfo(&aDT_FLOAT, 480, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[35].fieldinfo(&aDT_FLOAT, 484, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[36].fieldinfo(&aDT_FLOAT, 768, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[37].fieldinfo(&aDT_FLOAT, 852, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[38].fieldinfo(&aDT_FLOAT, 856, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[39].fieldinfo(&aDT_FLOAT, 860, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[40].fieldinfo(&aDT_FLOAT, 864, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[41].fieldinfo(&aDT_FLOAT, 580, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[42].fieldinfo(&aDT_FLOAT, 584, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[43].fieldinfo(&aDT_FLOAT, 588, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[44].fieldinfo(&aDT_FLOAT, 592, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[45].fieldinfo(&aDT_FLOAT, 596, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[46].fieldinfo(&aDT_FLOAT, 600, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[47].fieldinfo(&aDT_FLOAT, 608, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[48].fieldinfo(&aDT_FLOAT, 612, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[49].fieldinfo(&aDT_FLOAT, 676, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[50].fieldinfo(&aDT_FLOAT, 688, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[51].fieldinfo(&aDT_FLOAT, 692, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[52].fieldinfo(&aDT_FLOAT, 696, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[53].fieldinfo(&aDT_FLOAT, 700, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[54].fieldinfo(&aDT_FLOAT, 716, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[55].fieldinfo(&aDT_FLOAT, 720, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[56].fieldinfo(&aDT_FLOAT, 724, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[58 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
HeroData::~HeroData() {
		free(Fields);
}
...
Heros::Heros() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aHeroData, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Heros::~Heros() {
		free(Fields);
...
MovementStyleDefinition::MovementStyleDefinition() {
		...
		Fields[3].fieldinfo(&aDT_INT, 268, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 272, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 276, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_INT, 280, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 284, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 288, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 292, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLOAT, 296, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 300, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_FLOAT, 304, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_FLOAT, 308, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_FLOAT, 312, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_FLOAT, 316, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_FLOAT, 320, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_FLOAT, 324, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_FLOAT, 328, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_FLOAT, 332, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_FLOAT, 336, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_FLOAT, 340, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_FLOAT, 344, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_FLOAT, 348, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aDT_FLOAT, 352, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aDT_FLOAT, 356, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aDT_FLOAT, 360, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aDT_FLOAT, 364, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aDT_FLOAT, 368, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[29].fieldinfo(&aDT_FLOAT, 376, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[30].fieldinfo(&aDT_FLOAT, 372, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[31].fieldinfo(&aDT_SNO, 380, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[33 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
MovementStyleDefinition::~MovementStyleDefinition() {
		free(Fields);
}
...
MovementStyles::MovementStyles() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aMovementStyleDefinition, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
MovementStyles::~MovementStyles() {
		free(Fields);
...
Labels::Labels() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aLabelGBID, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Labels::~Labels() {
		free(Fields);
...
MonsterLevelDefinition::MonsterLevelDefinition() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_FLOAT, 484, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 488, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FLOAT, 496, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 492, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FLOAT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FLOAT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_FLOAT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLOAT, 184, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 92, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_FLOAT, 96, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_FLOAT, 100, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_FLOAT, 104, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_FLOAT, 108, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_FLOAT, 112, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_FLOAT, 116, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_FLOAT, 120, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_FLOAT, 124, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_FLOAT, 128, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_FLOAT, 132, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_FLOAT, 136, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_FLOAT, 440, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aDT_FLOAT, 444, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aDT_FLOAT, 140, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aDT_FLOAT, 144, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aDT_FLOAT, 460, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aDT_FLOAT, 464, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[29].fieldinfo(&aDT_FLOAT, 468, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[30].fieldinfo(&aDT_FLOAT, 472, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[31].fieldinfo(&aDT_FLOAT, 476, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[32].fieldinfo(&aDT_FLOAT, 504, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[33].fieldinfo(&aDT_FLOAT, 148, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[34].fieldinfo(&aDT_FLOAT, 152, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[35].fieldinfo(&aDT_FLOAT, 156, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[36].fieldinfo(&aDT_FLOAT, 160, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[37].fieldinfo(&aDT_FLOAT, 220, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[38].fieldinfo(&aDT_FLOAT, 224, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[39].fieldinfo(&aDT_FLOAT, 176, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[40].fieldinfo(&aDT_FLOAT, 520, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[41].fieldinfo(&aDT_FLOAT, 180, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[42].fieldinfo(&aDT_FLOAT, 232, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[43].fieldinfo(&aDT_FLOAT, 236, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[44].fieldinfo(&aDT_FLOAT, 268, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[45].fieldinfo(&aDT_FLOAT, 272, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[46].fieldinfo(&aDT_FLOAT, 276, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[47].fieldinfo(&aDT_FLOAT, 280, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[48].fieldinfo(&aDT_FLOAT, 284, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[49].fieldinfo(&aDT_FLOAT, 288, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[50].fieldinfo(&aDT_FLOAT, 292, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[51].fieldinfo(&aDT_FLOAT, 296, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[52].fieldinfo(&aDT_FLOAT, 300, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[54 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
MonsterLevelDefinition::~MonsterLevelDefinition() {
		free(Fields);
}
...
MonsterLevelTable::MonsterLevelTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aMonsterLevelDefinition, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
MonsterLevelTable::~MonsterLevelTable() {
		free(Fields);
...
AffixTableEntry::AffixTableEntry() {
		...
		Fields[5].fieldinfo(&aDT_INT, 276, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_INT, 280, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_ENUM, 284, 4, 0, 0, 14, 17, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 288, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_SNO, 292, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_SNO, 296, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_GBID, 300, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_GBID, 304, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_INT, 360, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_ENUM, 364, 4, 0, 0, 11, 17, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_FIXEDARRAY, 336, 32, 0, 0, 0, 1, &aDT_INT, 6);
		Fields[16].fieldinfo(&aDT_GBID, 368, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_GBID, 308, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_FIXEDARRAY, 312, 32, 0, 0, 0, 1, &aDT_INT, 6);
		Fields[19].fieldinfo(&aDT_FIXEDARRAY, 376, 0, 0, 0, 0, 1, &aAttributeSpecifier, 4);
		Fields[21 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AffixTableEntry::~AffixTableEntry() {
		free(Fields);
}
...
AffixTable::AffixTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aAffixTableEntry, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AffixTable::~AffixTable() {
		free(Fields);
...
SetItemBonusTableEntry::SetItemBonusTableEntry() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 4, 9, 0, 0, 0, 5, &aDT_NULL, 256);
		Fields[1].fieldinfo(&aDT_INT, 264, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_GBID, 260, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FIXEDARRAY, 272, 0, 0, 0, 0, 1, &aAttributeSpecifier, 8);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SetItemBonusTableEntry::~SetItemBonusTableEntry() {
		free(Fields);
...
SetItemBonusTable::SetItemBonusTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aSetItemBonusTableEntry, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SetItemBonusTable::~SetItemBonusTable() {
		free(Fields);
...
MonsterAffixesEntry::MonsterAffixesEntry() {
		...
		Fields[2].fieldinfo(&aDT_INT, 264, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 268, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_ENUM, 280, 4, 0, 0, 11, 17, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_ENUM, 272, 2, 0, 0, 3, 17, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_ENUM, 276, 3, 0, 0, 6, 17, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 284, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 288, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_INT, 292, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_SNO, 780, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_SNO, 788, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_SNO, 784, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_TRANSLATEABLE, 296, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_ATTRIBUTEPARAM, 300, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aSerializeData, 312, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_FORMULA, 304, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_TRANSLATEABLE, 320, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_ATTRIBUTEPARAM, 324, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aSerializeData, 336, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_FORMULA, 328, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_TRANSLATEABLE, 344, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_ATTRIBUTEPARAM, 348, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aSerializeData, 360, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aDT_FORMULA, 352, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aDT_TRANSLATEABLE, 368, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aDT_ATTRIBUTEPARAM, 372, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aSerializeData, 384, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aDT_FORMULA, 376, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[29].fieldinfo(&aDT_TRANSLATEABLE, 392, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[30].fieldinfo(&aDT_ATTRIBUTEPARAM, 396, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[31].fieldinfo(&aSerializeData, 408, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[32].fieldinfo(&aDT_FORMULA, 400, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[33].fieldinfo(&aDT_TRANSLATEABLE, 416, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[34].fieldinfo(&aDT_ATTRIBUTEPARAM, 420, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[35].fieldinfo(&aSerializeData, 432, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[36].fieldinfo(&aDT_FORMULA, 424, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[37].fieldinfo(&aDT_TRANSLATEABLE, 440, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[38].fieldinfo(&aDT_ATTRIBUTEPARAM, 444, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[39].fieldinfo(&aSerializeData, 456, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[40].fieldinfo(&aDT_FORMULA, 448, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[41].fieldinfo(&aDT_TRANSLATEABLE, 464, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[42].fieldinfo(&aDT_ATTRIBUTEPARAM, 468, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[43].fieldinfo(&aSerializeData, 480, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[44].fieldinfo(&aDT_FORMULA, 472, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[45].fieldinfo(&aDT_TRANSLATEABLE, 488, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[46].fieldinfo(&aDT_ATTRIBUTEPARAM, 492, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[47].fieldinfo(&aSerializeData, 504, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[48].fieldinfo(&aDT_FORMULA, 496, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[49].fieldinfo(&aDT_TRANSLATEABLE, 512, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[50].fieldinfo(&aDT_ATTRIBUTEPARAM, 516, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[51].fieldinfo(&aSerializeData, 528, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[52].fieldinfo(&aDT_FORMULA, 520, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[53].fieldinfo(&aDT_TRANSLATEABLE, 536, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[54].fieldinfo(&aDT_ATTRIBUTEPARAM, 540, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[55].fieldinfo(&aSerializeData, 552, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[56].fieldinfo(&aDT_FORMULA, 544, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[57].fieldinfo(&aDT_TRANSLATEABLE, 560, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[58].fieldinfo(&aDT_ATTRIBUTEPARAM, 564, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[59].fieldinfo(&aSerializeData, 576, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[60].fieldinfo(&aDT_FORMULA, 568, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[61].fieldinfo(&aDT_TRANSLATEABLE, 584, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[62].fieldinfo(&aDT_ATTRIBUTEPARAM, 588, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[63].fieldinfo(&aSerializeData, 600, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[64].fieldinfo(&aDT_FORMULA, 592, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[65].fieldinfo(&aDT_TRANSLATEABLE, 608, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[66].fieldinfo(&aDT_ATTRIBUTEPARAM, 612, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[67].fieldinfo(&aSerializeData, 624, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[68].fieldinfo(&aDT_FORMULA, 616, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[69].fieldinfo(&aDT_TRANSLATEABLE, 632, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[70].fieldinfo(&aDT_ATTRIBUTEPARAM, 636, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[71].fieldinfo(&aSerializeData, 648, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[72].fieldinfo(&aDT_FORMULA, 640, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[73].fieldinfo(&aDT_TRANSLATEABLE, 656, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[74].fieldinfo(&aDT_ATTRIBUTEPARAM, 660, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[75].fieldinfo(&aSerializeData, 672, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[76].fieldinfo(&aDT_FORMULA, 664, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[77].fieldinfo(&aDT_TRANSLATEABLE, 680, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[78].fieldinfo(&aDT_ATTRIBUTEPARAM, 684, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[79].fieldinfo(&aSerializeData, 696, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[80].fieldinfo(&aDT_FORMULA, 688, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[81].fieldinfo(&aDT_TRANSLATEABLE, 704, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[82].fieldinfo(&aDT_ATTRIBUTEPARAM, 708, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[83].fieldinfo(&aSerializeData, 720, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[84].fieldinfo(&aDT_FORMULA, 712, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[85].fieldinfo(&aDT_TRANSLATEABLE, 728, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[86].fieldinfo(&aDT_ATTRIBUTEPARAM, 732, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[87].fieldinfo(&aSerializeData, 744, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[88].fieldinfo(&aDT_FORMULA, 736, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[89].fieldinfo(&aDT_TRANSLATEABLE, 752, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[90].fieldinfo(&aDT_ATTRIBUTEPARAM, 756, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[91].fieldinfo(&aSerializeData, 768, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[92].fieldinfo(&aDT_FORMULA, 760, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[94 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
MonsterAffixesEntry::~MonsterAffixesEntry() {
		free(Fields);
}
...
MonsterAffixesTable::MonsterAffixesTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aMonsterAffixesEntry, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
MonsterAffixesTable::~MonsterAffixesTable() {
		free(Fields);
...
RareMonsterNamesEntry::RareMonsterNamesEntry() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 4, 9, 0, 0, 0, 5, &aDT_NULL, 256);
		Fields[1].fieldinfo(&aDT_ENUM, 260, 4, 0, 0, 11, 17, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_CHARARRAY, 264, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
RareMonsterNamesEntry::~RareMonsterNamesEntry() {
		free(Fields);
...
RareMonsterNamesTable::RareMonsterNamesTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aRareMonsterNamesEntry, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
RareMonsterNamesTable::~RareMonsterNamesTable() {
		free(Fields);
...
RareItemNamesEntry::RareItemNamesEntry() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 4, 9, 0, 0, 0, 5, &aDT_NULL, 256);
		Fields[1].fieldinfo(&aDT_GBID, 264, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_ENUM, 260, 6, 0, 1, 37, 17, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_ENUM, 268, 4, 0, 0, 11, 17, &aDT_NULL, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
RareItemNamesEntry::~RareItemNamesEntry() {
		free(Fields);
...
RareItemNamesTable::RareItemNamesTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aRareItemNamesEntry, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
RareItemNamesTable::~RareItemNamesTable() {
		free(Fields);
...
SocketedEffectsTableEntry::SocketedEffectsTableEntry() {
		...
		Fields[1].fieldinfo(&aDT_GBID, 260, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_GBID, 264, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_TRANSLATEABLE, 272, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_ATTRIBUTEPARAM, 276, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aSerializeData, 288, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FORMULA, 280, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_TRANSLATEABLE, 296, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_ATTRIBUTEPARAM, 300, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aSerializeData, 312, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FORMULA, 304, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_TRANSLATEABLE, 320, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_ATTRIBUTEPARAM, 324, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aSerializeData, 336, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_FORMULA, 328, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_TRANSLATEABLE, 344, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_ATTRIBUTEPARAM, 348, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aSerializeData, 360, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_FORMULA, 352, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_TRANSLATEABLE, 368, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_ATTRIBUTEPARAM, 372, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aSerializeData, 384, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_FORMULA, 376, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_CHARARRAY, 392, 11, 0, 0, 0, 1, &aDT_NULL, 1024);
		Fields[25 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SocketedEffectsTableEntry::~SocketedEffectsTableEntry() {
		free(Fields);
}
...
SocketedEffectsTable::SocketedEffectsTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aSocketedEffectsTableEntry, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SocketedEffectsTable::~SocketedEffectsTable() {
		free(Fields);
...
ItemDropTableEntry::ItemDropTableEntry() {
		...
		Fields[8].fieldinfo(&aDT_INT, 288, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_INT, 292, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_INT, 296, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_INT, 300, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_INT, 304, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_INT, 308, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_INT, 312, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_INT, 316, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_INT, 320, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_INT, 324, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_INT, 328, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_INT, 332, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_INT, 336, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_INT, 340, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_INT, 344, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_INT, 348, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aDT_INT, 352, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aDT_INT, 356, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aDT_INT, 360, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aDT_INT, 364, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aDT_INT, 368, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[29].fieldinfo(&aDT_INT, 372, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[30].fieldinfo(&aDT_INT, 376, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[31].fieldinfo(&aDT_INT, 380, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[32].fieldinfo(&aDT_INT, 384, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[33].fieldinfo(&aDT_INT, 388, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[34].fieldinfo(&aDT_INT, 392, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[35].fieldinfo(&aDT_INT, 396, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[36].fieldinfo(&aDT_INT, 400, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[37].fieldinfo(&aDT_INT, 404, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[38].fieldinfo(&aDT_INT, 408, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[39].fieldinfo(&aDT_INT, 412, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[40].fieldinfo(&aDT_INT, 416, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[41].fieldinfo(&aDT_INT, 420, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[42].fieldinfo(&aDT_INT, 424, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[43].fieldinfo(&aDT_INT, 428, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[44].fieldinfo(&aDT_INT, 432, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[45].fieldinfo(&aDT_INT, 436, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[46].fieldinfo(&aDT_INT, 440, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[47].fieldinfo(&aDT_INT, 444, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[48].fieldinfo(&aDT_INT, 448, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[49].fieldinfo(&aDT_INT, 452, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[50].fieldinfo(&aDT_INT, 456, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[51].fieldinfo(&aDT_INT, 460, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[52].fieldinfo(&aDT_INT, 464, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[53].fieldinfo(&aDT_INT, 468, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[54].fieldinfo(&aDT_INT, 472, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[55].fieldinfo(&aDT_INT, 476, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[56].fieldinfo(&aDT_INT, 480, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[57].fieldinfo(&aDT_INT, 484, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[58].fieldinfo(&aDT_INT, 488, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[59].fieldinfo(&aDT_INT, 492, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[60].fieldinfo(&aDT_INT, 496, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[61].fieldinfo(&aDT_INT, 500, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[62].fieldinfo(&aDT_INT, 504, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[63].fieldinfo(&aDT_INT, 508, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[64].fieldinfo(&aDT_INT, 512, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[65].fieldinfo(&aDT_INT, 516, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[66].fieldinfo(&aDT_INT, 520, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[67].fieldinfo(&aDT_INT, 524, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[68].fieldinfo(&aDT_INT, 528, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[69].fieldinfo(&aDT_INT, 532, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[70].fieldinfo(&aDT_INT, 536, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[71].fieldinfo(&aDT_INT, 540, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[72].fieldinfo(&aDT_INT, 544, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[73].fieldinfo(&aDT_INT, 548, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[74].fieldinfo(&aDT_INT, 552, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[75].fieldinfo(&aDT_INT, 556, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[76].fieldinfo(&aDT_INT, 560, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[77].fieldinfo(&aDT_INT, 564, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[78].fieldinfo(&aDT_INT, 568, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[79].fieldinfo(&aDT_INT, 572, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[80].fieldinfo(&aDT_INT, 576, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[81].fieldinfo(&aDT_INT, 580, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[82].fieldinfo(&aDT_INT, 584, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[83].fieldinfo(&aDT_INT, 588, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[84].fieldinfo(&aDT_INT, 592, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[85].fieldinfo(&aDT_INT, 596, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[86].fieldinfo(&aDT_INT, 600, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[87].fieldinfo(&aDT_INT, 604, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[88].fieldinfo(&aDT_INT, 608, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[89].fieldinfo(&aDT_INT, 612, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[90].fieldinfo(&aDT_INT, 616, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[91].fieldinfo(&aDT_INT, 620, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[92].fieldinfo(&aDT_INT, 624, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[93].fieldinfo(&aDT_INT, 628, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[94].fieldinfo(&aDT_INT, 632, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[95].fieldinfo(&aDT_INT, 636, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[96].fieldinfo(&aDT_INT, 640, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[97].fieldinfo(&aDT_INT, 644, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[98].fieldinfo(&aDT_INT, 648, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[99].fieldinfo(&aDT_INT, 652, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[100].fieldinfo(&aDT_INT, 656, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[101].fieldinfo(&aDT_INT, 660, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[102].fieldinfo(&aDT_INT, 664, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[103].fieldinfo(&aDT_INT, 668, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[104].fieldinfo(&aDT_INT, 672, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[105].fieldinfo(&aDT_INT, 676, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[106].fieldinfo(&aDT_INT, 680, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[107].fieldinfo(&aDT_INT, 684, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[108].fieldinfo(&aDT_INT, 688, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[109].fieldinfo(&aDT_INT, 692, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[110].fieldinfo(&aDT_INT, 696, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[111].fieldinfo(&aDT_INT, 700, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[112].fieldinfo(&aDT_INT, 704, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[113].fieldinfo(&aDT_INT, 708, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[114].fieldinfo(&aDT_INT, 712, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[115].fieldinfo(&aDT_INT, 716, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[116].fieldinfo(&aDT_INT, 720, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[117].fieldinfo(&aDT_INT, 724, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[118].fieldinfo(&aDT_INT, 728, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[119].fieldinfo(&aDT_INT, 732, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[120].fieldinfo(&aDT_INT, 736, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[121].fieldinfo(&aDT_INT, 740, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[122].fieldinfo(&aDT_INT, 744, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[123].fieldinfo(&aDT_INT, 748, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[124].fieldinfo(&aDT_INT, 752, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[125].fieldinfo(&aDT_INT, 756, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[126].fieldinfo(&aDT_INT, 760, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[127].fieldinfo(&aDT_INT, 764, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[128].fieldinfo(&aDT_INT, 768, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[129].fieldinfo(&aDT_INT, 772, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[130].fieldinfo(&aDT_INT, 776, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[131].fieldinfo(&aDT_INT, 780, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[132].fieldinfo(&aDT_INT, 784, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[133].fieldinfo(&aDT_INT, 788, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[134].fieldinfo(&aDT_INT, 792, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[135].fieldinfo(&aDT_INT, 796, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[136].fieldinfo(&aDT_INT, 800, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[137].fieldinfo(&aDT_INT, 804, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[138].fieldinfo(&aDT_INT, 808, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[139].fieldinfo(&aDT_INT, 812, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[140].fieldinfo(&aDT_INT, 816, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[141].fieldinfo(&aDT_INT, 820, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[142].fieldinfo(&aDT_INT, 824, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[143].fieldinfo(&aDT_INT, 828, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[144].fieldinfo(&aDT_INT, 832, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[145].fieldinfo(&aDT_INT, 836, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[146].fieldinfo(&aDT_INT, 840, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[147].fieldinfo(&aDT_INT, 844, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[148].fieldinfo(&aDT_INT, 848, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[149].fieldinfo(&aDT_INT, 852, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[150].fieldinfo(&aDT_INT, 856, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[151].fieldinfo(&aDT_INT, 860, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[152].fieldinfo(&aDT_INT, 864, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[153].fieldinfo(&aDT_INT, 868, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[154].fieldinfo(&aDT_INT, 872, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[155].fieldinfo(&aDT_INT, 876, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[156].fieldinfo(&aDT_INT, 880, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[157].fieldinfo(&aDT_INT, 884, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[158].fieldinfo(&aDT_INT, 888, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[159].fieldinfo(&aDT_INT, 892, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[160].fieldinfo(&aDT_INT, 896, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[161].fieldinfo(&aDT_INT, 900, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[162].fieldinfo(&aDT_INT, 904, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[163].fieldinfo(&aDT_INT, 908, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[164].fieldinfo(&aDT_INT, 912, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[165].fieldinfo(&aDT_INT, 916, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[166].fieldinfo(&aDT_INT, 920, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[167].fieldinfo(&aDT_INT, 924, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[168].fieldinfo(&aDT_INT, 928, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[169].fieldinfo(&aDT_INT, 932, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[170].fieldinfo(&aDT_INT, 936, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[171].fieldinfo(&aDT_INT, 940, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[172].fieldinfo(&aDT_INT, 944, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[173].fieldinfo(&aDT_INT, 948, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[174].fieldinfo(&aDT_INT, 952, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[175].fieldinfo(&aDT_INT, 956, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[176].fieldinfo(&aDT_INT, 960, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[177].fieldinfo(&aDT_INT, 964, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[178].fieldinfo(&aDT_INT, 968, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[179].fieldinfo(&aDT_INT, 972, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[180].fieldinfo(&aDT_INT, 976, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[181].fieldinfo(&aDT_INT, 980, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[182].fieldinfo(&aDT_INT, 984, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[183].fieldinfo(&aDT_INT, 988, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[184].fieldinfo(&aDT_INT, 992, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[185].fieldinfo(&aDT_INT, 996, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[186].fieldinfo(&aDT_INT, 1000, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[187].fieldinfo(&aDT_INT, 1004, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[188].fieldinfo(&aDT_INT, 1008, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[189].fieldinfo(&aDT_INT, 1012, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[190].fieldinfo(&aDT_INT, 1016, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[191].fieldinfo(&aDT_INT, 1024, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[192].fieldinfo(&aDT_INT, 1028, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[193].fieldinfo(&aDT_INT, 1032, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[194].fieldinfo(&aDT_INT, 1036, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[195].fieldinfo(&aDT_INT, 1040, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[196].fieldinfo(&aDT_INT, 1044, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[197].fieldinfo(&aDT_INT, 1048, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[198].fieldinfo(&aDT_INT, 1052, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[199].fieldinfo(&aDT_INT, 1056, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[200].fieldinfo(&aDT_INT, 1060, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[201].fieldinfo(&aDT_INT, 1064, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[202].fieldinfo(&aDT_INT, 1068, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[203].fieldinfo(&aDT_INT, 1072, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[204].fieldinfo(&aDT_INT, 1076, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[205].fieldinfo(&aDT_INT, 1080, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[206].fieldinfo(&aDT_INT, 1084, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[207].fieldinfo(&aDT_INT, 1088, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[208].fieldinfo(&aDT_INT, 1092, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[209].fieldinfo(&aDT_INT, 1096, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[210].fieldinfo(&aDT_INT, 1100, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[211].fieldinfo(&aDT_INT, 1104, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[212].fieldinfo(&aDT_INT, 1108, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[213].fieldinfo(&aDT_INT, 1112, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[214].fieldinfo(&aDT_INT, 1116, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[215].fieldinfo(&aDT_INT, 1120, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[216].fieldinfo(&aDT_INT, 1124, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[217].fieldinfo(&aDT_INT, 1128, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[218].fieldinfo(&aDT_INT, 1132, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[219].fieldinfo(&aDT_INT, 1136, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[221 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ItemDropTableEntry::~ItemDropTableEntry() {
		free(Fields);
}
...
ItemDropTable::ItemDropTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aItemDropTableEntry, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ItemDropTable::~ItemDropTable() {
		free(Fields);
...
HirelingEntry::HirelingEntry() {
		...
		Fields[2].fieldinfo(&aDT_SNO, 264, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_SNO, 268, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 752, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FLOAT, 756, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FLOAT, 764, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 760, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_FLOAT, 776, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 780, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLOAT, 784, 32, 0, 0, 0, 1, &aDT_NULL, -1);
...
Hirelings::Hirelings() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aHirelingEntry, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Hirelings::~Hirelings() {
		free(Fields);
...
EliteModifierData::EliteModifierData() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 4, 9, 0, 0, 0, 5, &aDT_NULL, 256);
		Fields[1].fieldinfo(&aDT_FLOAT, 260, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_TIME, 264, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FLOAT, 268, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_TIME, 272, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FLOAT, 276, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_TIME, 280, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 284, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_TIME, 288, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 292, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_TIME, 296, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 300, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_TIME, 304, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_FLOAT, 308, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_TIME, 312, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_FLOAT, 316, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_FLOAT, 320, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_TIME, 324, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_FLOAT, 328, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_FLOAT, 332, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_FLOAT, 336, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_FLOAT, 340, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
EliteModifierData::~EliteModifierData() {
		free(Fields);
}
...
EliteModifiers::EliteModifiers() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aEliteModifierData, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
EliteModifiers::~EliteModifiers() {
		free(Fields);
...
RecipeEntry::RecipeEntry() {
		...
		Fields[0].fieldinfo(&aDT_CHARARRAY, 4, 9, 0, 0, 0, 5, &aDT_NULL, 256);
		Fields[1].fieldinfo(&aDT_SNO, 260, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_ENUM, 264, 2, 0, 0, 3, 17, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 268, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 272, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 276, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_INT, 280, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FIXEDARRAY, 284, 0, 0, 0, 0, 1, &aRecipeIngredient, 6);
		Fields[9 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
RecipeEntry::~RecipeEntry() {
		free(Fields);
...
RecipesTable::RecipesTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aRecipeEntry, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
RecipesTable::~RecipesTable() {
		free(Fields);
...
ScriptedAchievementEventsTable::ScriptedAchievementEventsTable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aScriptedAchievementEvent, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ScriptedAchievementEventsTable::~ScriptedAchievementEventsTable() {
		free(Fields);
...
GameBalance::GameBalance() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 16, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[2].fieldinfo(&aDT_CHARARRAY, 272, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[3].fieldinfo(&aDT_INT, 528, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 532, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aItems_1, 536, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aItems, 552, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aExperienceTable, 568, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aHelpCodes_1, 584, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aMonsterLevelTable, 600, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aHeros, 632, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aMovementStyles, 648, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aLabels, 664, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aAffixTable, 616, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aLootDistributionTable, 680, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aRareItemNamesTable, 696, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aMonsterAffixesTable, 712, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aRareMonsterNamesTable, 728, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aSocketedEffectsTable, 744, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aItemEnhancementTable, 760, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aItemDropTable, 776, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aItemLevelModTable, 792, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aQualityClassTable, 808, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aHirelings, 824, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aSetItemBonusTable, 840, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aEliteModifiers, 856, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aItemTiers, 872, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aPowerFormulaTable, 888, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aRecipesTable, 904, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[29].fieldinfo(&aScriptedAchievementEventsTable, 920, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[31 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
GameBalance::~GameBalance() {
		free(Fields);
}
...
SkillKeyMapping::SkillKeyMapping() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_SNO, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 4, 0, 0, 9, 17, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SkillKeyMapping::~SkillKeyMapping() {
		free(Fields);
...
PlayerSavedQuest::PlayerSavedQuest() {
		...
		Fields[0].fieldinfo(&aDT_SNO, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FIXEDARRAY, 12, 32, 0, 0, 0, 1, &aDT_INT, 20);
		Fields[3].fieldinfo(&aDT_FIXEDARRAY, 92, 32, 0, 0, 0, 1, &aDT_INT, 20);
		Fields[4].fieldinfo(&aDT_ENUM, 4, 2, 0, 0, 3, 17, &aDT_NULL, -1);
...
PlayerQuestHistoryEntry::PlayerQuestHistoryEntry() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_SNO, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_ENUM, 4, 2, 0, 0, 3, 17, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
PlayerQuestHistoryEntry::~PlayerQuestHistoryEntry() {
		free(Fields);
...
PlayerQuestRewardHistoryEntry::PlayerQuestRewardHistoryEntry() {
		...
		Fields[0].fieldinfo(&aDT_SNO, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_ENUM, 8, 2, 0, 0, 3, 17, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
PlayerQuestRewardHistoryEntry::~PlayerQuestRewardHistoryEntry() {
		free(Fields);
...
HirelingInfo::HirelingInfo() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 10);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 2, 0, 0, 3, 17, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 7, 0, 0, 127, 17, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
...
HirelingSavedData::HirelingSavedData() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_FIXEDARRAY, 0, 0, 0, 0, 0, 1, &aHirelingInfo, 4);
		Fields[1].fieldinfo(&aDT_INT, 144, 2, 0, 0, 3, 17, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 148, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
HirelingSavedData::~HirelingSavedData() {
		free(Fields);
...
LearnedLore::LearnedLore() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_FIXEDARRAY, 4, 32, 0, 0, 0, 1, &aDT_SNO, 256);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
LearnedLore::~LearnedLore() {
		free(Fields);
...
SavedConversations::SavedConversations() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_FIXEDARRAY, 4, 8, 0, 0, 0, 1, &aDT_BYTE, 32);
		Fields[2].fieldinfo(&aDT_FIXEDARRAY, 36, 32, 0, 0, 0, 1, &aDT_SNO, 256);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SavedConversations::~SavedConversations() {
		free(Fields);
...
PlayerSavedData::PlayerSavedData() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 12);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_FIXEDARRAY, 0, 0, 0, 0, 0, 1, &aHotbarButtonData, 9);
		Fields[1].fieldinfo(&aDT_FIXEDARRAY, 72, 0, 0, 0, 0, 1, &aSkillKeyMapping, 15);
		Fields[2].fieldinfo(&aDT_TIME, 252, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 256, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aHirelingSavedData, 260, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 412, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aLearnedLore, 416, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FIXEDARRAY, 2504, 32, 0, 0, 0, 1, &aDT_SNO, 6);
		Fields[8].fieldinfo(&aDT_FIXEDARRAY, 2528, 32, 0, 0, 0, 1, &aDT_SNO, 3);
		Fields[9].fieldinfo(&aSavePointData, 2796, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FIXEDARRAY, 2540, 32, 0, 0, 0, 1, &aDT_SNO, 64);
		Fields[12 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
PlayerSavedData::~PlayerSavedData() {
		free(Fields);
...
Hero::Hero() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 12, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 24, 0, 0, 0, 0, 32, &aDT_BYTE, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Hero::~Hero() {
		free(Fields);
...
Tutorial::Tutorial() {
		...
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_TIME, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Tutorial::~Tutorial() {
		free(Fields);
...
BossEncounter::BossEncounter() {
		...
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_INT, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 44, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_INT, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_SNO, 52, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FIXEDARRAY, 56, 32, 0, 0, 0, 1, &aDT_SNO, 4);
		Fields[12].fieldinfo(&aDT_FIXEDARRAY, 72, 32, 0, 0, 0, 1, &aDT_SNO, 3);
		Fields[14 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
BossEncounter::~BossEncounter() {
		free(Fields);
...
ItemSpecifierData::ItemSpecifierData() {
		...
		Fields[0].fieldinfo(&aDT_GBID, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FIXEDARRAY, 8, 32, 0, 0, 0, 1, &aDT_GBID, 3);
		Fields[3].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ItemSpecifierData::~ItemSpecifierData() {
		free(Fields);
...
LootDropModifier::LootDropModifier() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_SNO, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aItemSpecifierData, 32, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_GBID, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_HIGHPRECISIONPERCENT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_SNO, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FIXEDARRAY, 60, 32, 0, 0, 0, 0, &aDT_INT, 4);
		Fields[10].fieldinfo(&aDT_INT, 56, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
LootDropModifier::~LootDropModifier() {
		free(Fields);
...
TreasureClass::TreasureClass() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 6);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_HIGHPRECISIONPERCENT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_VARIABLEARRAY, 24, 0, 0, 0, 0, 33, &aLootDropModifier, -1);
		Fields[6 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
TreasureClass::~TreasureClass() {
		free(Fields);
...
GameFlagSubcondition::GameFlagSubcondition() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 2);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[2 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
GameFlagSubcondition::~GameFlagSubcondition() {
		free(Fields);
...
FollowerSubcondition::FollowerSubcondition() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_ENUM, 0, 2, 0, 0, 3, 17, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
FollowerSubcondition::~FollowerSubcondition() {
...
Condition::Condition() {
		...
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FIXEDARRAY, 20, 32, 0, 0, 0, 1, &aDT_INT, 5);
		Fields[3].fieldinfo(&aDT_FIXEDARRAY, 40, 32, 0, 0, 0, 1, &aDT_INT, 4);
		Fields[4].fieldinfo(&aDT_FIXEDARRAY, 56, 0, 0, 0, 0, 1, &aLoreSubcondition, 3);
		Fields[5].fieldinfo(&aDT_FIXEDARRAY, 80, 0, 0, 0, 0, 1, &aQuestSubcondition, 3);
		Fields[6].fieldinfo(&aDT_FIXEDARRAY, 128, 0, 0, 0, 0, 1, &aItemSubcondition, 3);
		Fields[7].fieldinfo(&aDT_INT, 176, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 180, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_INT, 184, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_INT, 188, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_INT, 196, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_INT, 200, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_INT, 204, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_INT, 208, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_SNO, 212, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_SNO, 216, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_SNO, 220, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aFollowerSubcondition, 224, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_FIXEDARRAY, 232, 0, 0, 0, 0, 1, &aLabelSubcondition, 3);
		Fields[20].fieldinfo(&aDT_FIXEDARRAY, 256, 0, 0, 0, 0, 1, &aSkillSubcondition, 3);
		Fields[21].fieldinfo(&aDT_FIXEDARRAY, 292, 0, 0, 0, 0, 1, &aMonsterSubcondition, 3);
		Fields[22].fieldinfo(&aDT_FIXEDARRAY, 304, 0, 0, 0, 0, 1, &aGameFlagSubcondition, 3);
		Fields[23].fieldinfo(&aDT_FIXEDARRAY, 688, 0, 0, 0, 0, 1, &aPlayerFlagSubcondition, 3);
		Fields[25 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Condition::~Condition() {
		free(Fields);
...
Lore::Lore() {
		...
		Fields[2].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_SNO, 28, 32, 0, 0, 0, 257, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Lore::~Lore() {
...
ResolvedPortalDestination::ResolvedPortalDestination() {
		...
		Fields[0].fieldinfo(&aDT_SNO, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_SNO, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ResolvedPortalDestination::~ResolvedPortalDestination() {
		free(Fields);
...
WaypointInfo::WaypointInfo() {
		...
		Fields[3].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_SNO, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_INT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
WaypointInfo::~WaypointInfo() {
...
ActStartLocOverride::ActStartLocOverride() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aResolvedPortalDestination, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_SNO, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ActStartLocOverride::~ActStartLocOverride() {
		free(Fields);
...
Act::Act() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 12, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 24, 0, 0, 0, 0, 33, &aActQuestInfo, -1);
		Fields[2].fieldinfo(&aDT_FIXEDARRAY, 32, 0, 0, 0, 0, 1, &aWaypointInfo, 25);
		Fields[3].fieldinfo(&aResolvedPortalDestination, 732, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FIXEDARRAY, 744, 0, 0, 0, 0, 1, &aActStartLocOverride, 6);
		Fields[6 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Act::~Act() {
		free(Fields);
...
TimedEvent::TimedEvent() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 2);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_TIME, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
TimedEvent::~TimedEvent() {
		free(Fields);
...
Recipe::Recipe() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 2);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aItemSpecifierData, 12, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Recipe::~Recipe() {
		free(Fields);
...
MonsterMinionSpawnGroup::MonsterMinionSpawnGroup() {
		...
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aSerializeData, 16, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aMonsterMinionSpawnItem, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
MonsterMinionSpawnGroup::~MonsterMinionSpawnGroup() {
		free(Fields);
...
Monster_1::Monster_1() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_SNO, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_ENUM, 24, 4, 0, 0, 8, 17, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_ENUM, 28, 4, 0, -1, 10, 17, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_ENUM, 32, 4, 0, -1, 7, 17, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_ENUM, 56, 3, 0, 0, 6, 17, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 60, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FIXEDARRAY, 68, 32, 0, 0, 0, 1, &aDT_INT, 4);
		Fields[10].fieldinfo(&aDT_FLOAT, 636, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 640, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_FLOAT, 644, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_FLOAT, 648, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_FLOAT, 652, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_FLOAT, 656, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_SNO, 948, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_SNO, 952, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_SNO, 956, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aHealthDropInfo, 664, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aHealthDropInfo, 676, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aHealthDropInfo, 688, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_INT, 660, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_ENUM, 1092, 3, 0, 0, 6, 17, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aDT_FIXEDARRAY, 84, 32, 0, 0, 0, 1, &aDT_FLOAT, 138);
		Fields[25].fieldinfo(&aDT_SNO, 700, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aDT_FIXEDARRAY, 704, 0, 0, 0, 0, 1, &aSkillDeclaration, 8);
		Fields[27].fieldinfo(&aDT_FIXEDARRAY, 768, 0, 0, 0, 0, 1, &aMonsterSkillDeclaration, 8);
		Fields[28].fieldinfo(&aDT_SNO, 896, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[29].fieldinfo(&aDT_SNO, 900, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[30].fieldinfo(&aDT_SNO, 904, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[31].fieldinfo(&aDT_SNO, 908, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[32].fieldinfo(&aDT_SNO, 912, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[33].fieldinfo(&aMonster, 36, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[34].fieldinfo(&aDT_FLOAT, 916, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[35].fieldinfo(&aDT_FLOAT, 920, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[36].fieldinfo(&aDT_FLOAT, 924, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[37].fieldinfo(&aDT_FLOAT, 928, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[38].fieldinfo(&aDT_INT, 932, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[39].fieldinfo(&aDT_FLOAT, 936, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[40].fieldinfo(&aDT_INT, 940, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[41].fieldinfo(&aDT_INT, 944, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[42].fieldinfo(&aDT_FIXEDARRAY, 960, 32, 0, 0, 0, 1, &aDT_SNO, 6);
		Fields[43].fieldinfo(&aDT_FIXEDARRAY, 984, 32, 0, 0, 0, 1, &aDT_GBID, 8);
		Fields[44].fieldinfo(&aDT_FIXEDARRAY, 1016, 32, 0, 0, 0, 1, &aDT_SNO, 6);
		Fields[45].fieldinfo(&aDT_FIXEDARRAY, 1040, 32, 0, 0, 0, 1, &aDT_GBID, 4);
		Fields[46].fieldinfo(&aDT_FIXEDARRAY, 1056, 32, 0, 0, 0, 1, &aDT_GBID, 6);
		Fields[47].fieldinfo(&aDT_INT, 1080, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[48].fieldinfo(&aDT_INT, 1084, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[49].fieldinfo(&aDT_INT, 1088, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[50].fieldinfo(&aDT_CHARARRAY, 1160, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[51].fieldinfo(&aSerializeData, 1120, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[52].fieldinfo(&aDT_TAGMAP, 1128, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[53].fieldinfo(&aDT_INT, 1136, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[54].fieldinfo(&aSerializeData, 1152, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[55].fieldinfo(&aDT_VARIABLEARRAY, 1144, 0, 0, 0, 0, 33, &aMonsterMinionSpawnGroup, -1);
		Fields[57 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Monster_1::~Monster_1() {
		free(Fields);
}
...
TraitEntry::TraitEntry() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_SNO, 0, 32, 0, 0, 0, 257, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
...
SkillKit::SkillKit() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 5);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 24, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 16, 0, 0, 0, 0, 33, &aTraitEntry, -1);
		Fields[2].fieldinfo(&aSerializeData, 40, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_VARIABLEARRAY, 32, 0, 0, 0, 0, 33, &aActiveSkillEntry, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SkillKit::~SkillKit() {
		free(Fields);
...
QuestTime::QuestTime() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_SNO, 0, 32, 0, 0, 0, 513, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
QuestTime::~QuestTime() {
...
QuestRange::QuestRange() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aQuestTime, 12, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aQuestTime, 20, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
QuestRange::~QuestRange() {
		free(Fields);
...
QuestStepObjective::QuestStepObjective() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_ENUM, 4, 4, 0, 0, 13, 17, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSNOName, 16, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aSNOName, 24, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_GBID, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_GBID, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_CHARARRAY, 40, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[9].fieldinfo(&aDT_CHARARRAY, 296, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[10].fieldinfo(&aDT_INT, 552, 1, 0, 0, 1, 17, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_INT, 556, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_GBID, 560, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
QuestStepObjective::~QuestStepObjective() {
		free(Fields);
...
QuestStepObjectiveSet::QuestStepObjectiveSet() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 16, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aQuestStepObjective, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
QuestStepObjectiveSet::~QuestStepObjectiveSet() {
		free(Fields);
...
QuestStepBonusObjectiveSet::QuestStepBonusObjectiveSet() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 8);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_FIXEDARRAY, 0, 32, 0, 0, 0, 1, &aDT_INT, 4);
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 24, 1, 0, 0, 1, 17, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 28, 1, 0, 0, 1, 17, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aSerializeData, 40, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_VARIABLEARRAY, 32, 0, 0, 0, 0, 33, &aQuestStepObjective, -1);
		Fields[8 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
QuestStepBonusObjectiveSet::~QuestStepBonusObjectiveSet() {
		free(Fields);
...
QuestStepFailureCondition::QuestStepFailureCondition() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 10);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_ENUM, 0, 3, 0, 0, 7, 17, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aSNOName, 12, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSNOName, 20, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_GBID, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_GBID, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_CHARARRAY, 36, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[8].fieldinfo(&aDT_CHARARRAY, 292, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[10 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
QuestStepFailureCondition::~QuestStepFailureCondition() {
		free(Fields);
...
QuestStepFailureConditionSet::QuestStepFailureConditionSet() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 8, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 0, 0, 0, 0, 0, 33, &aQuestStepFailureCondition, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
QuestStepFailureConditionSet::~QuestStepFailureConditionSet() {
		free(Fields);
...
QuestUnassignedStep::QuestUnassignedStep() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 16, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aQuestStepObjectiveSet, -1);
		Fields[3].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_VARIABLEARRAY, 24, 0, 0, 0, 0, 33, &aQuestStepFailureConditionSet, -1);
		Fields[6 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
QuestUnassignedStep::~QuestUnassignedStep() {
		free(Fields);
...
QuestStep::QuestStep() {
		...
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[1].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_ENUM, 88, 2, 0, 0, 3, 17, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FIXEDARRAY, 92, 32, 0, 0, 0, 1, &aDT_SNO, 5);
		Fields[4].fieldinfo(&aDT_SNO, 112, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FIXEDARRAY, 72, 32, 0, 0, 0, 1, &aDT_INT, 4);
		Fields[6].fieldinfo(&aDT_INT, 116, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 120, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_ENUM, 124, 2, 0, 0, 3, 17, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FIXEDARRAY, 128, 32, 0, 0, 0, 1, &aDT_SNO, 5);
		Fields[10].fieldinfo(&aDT_SNO, 148, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_INT, 152, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_INT, 156, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aSerializeData, 184, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_VARIABLEARRAY, 176, 0, 0, 0, 0, 33, &aQuestStepObjectiveSet, -1);
		Fields[15].fieldinfo(&aSerializeData, 200, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_VARIABLEARRAY, 192, 0, 0, 0, 0, 33, &aQuestStepBonusObjectiveSet, -1);
		Fields[17].fieldinfo(&aSerializeData, 216, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_VARIABLEARRAY, 208, 0, 0, 0, 0, 33, &aQuestStepFailureConditionSet, -1);
		Fields[19].fieldinfo(&aDT_INT, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_SNO, 160, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_FIXEDARRAY, 164, 32, 0, 0, 0, 1, &aDT_SNO, 2);
		Fields[23 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
QuestStep::~QuestStep() {
		free(Fields);
...
QuestCompletionStep::QuestCompletionStep() {
		...
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[1].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 68, 1, 0, 0, 1, 17, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
QuestCompletionStep::~QuestCompletionStep() {
		free(Fields);
...
Quest::Quest() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 17);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_ENUM, 12, 2, 0, 0, 2, 17, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aQuestUnassignedStep, 40, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aSerializeData, 88, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_VARIABLEARRAY, 80, 0, 0, 0, 0, 33, &aQuestStep, -1);
		Fields[7].fieldinfo(&aSerializeData, 104, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_VARIABLEARRAY, 96, 0, 0, 0, 0, 33, &aQuestCompletionStep, -1);
		Fields[9].fieldinfo(&aDT_INT, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_INT, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aQuestLevelRange, 112, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aQuestLevelRange, 120, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aQuestLevelRange, 128, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aQuestLevelRange, 136, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Quest::~Quest() {
		free(Fields);
...
LevelAreaSpawnItem::LevelAreaSpawnItem() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 7);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSNOName, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_ENUM, 8, 3, 0, 0, 6, 17, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
...
LevelAreaSpawnGroup::LevelAreaSpawnGroup() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 10);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_ENUM, 0, 1, 0, 0, 1, 17, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_FLOAT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_VARIABLEARRAY, 24, 0, 0, 0, 0, 33, &aLevelAreaSpawnItem, -1);
		Fields[7].fieldinfo(&aDT_INT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 44, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
...
LevelAreaSpawnPopulation::LevelAreaSpawnPopulation() {
		...
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[1].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FIXEDARRAY, 68, 32, 0, 0, 0, 1, &aDT_INT, 4);
		Fields[3].fieldinfo(&aDT_INT, 84, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSerializeData, 96, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_VARIABLEARRAY, 88, 0, 0, 0, 0, 33, &aLevelAreaSpawnGroup, -1);
		Fields[7 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
LevelAreaSpawnPopulation::~LevelAreaSpawnPopulation() {
		free(Fields);
...
LevelArea::LevelArea() {
		...
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_SNO, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aGizmoLocSet, 24, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 9176, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aSerializeData, 9192, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_VARIABLEARRAY, 9184, 0, 0, 0, 0, 33, &aLevelAreaSpawnPopulation, -1);
		Fields[8 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
LevelArea::~LevelArea() {
		free(Fields);
...
SceneGroup::SceneGroup() {
		...
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 16, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 24, 0, 0, 0, 0, 33, &aSceneGroupItem, -1);
		Fields[3].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SceneGroup::~SceneGroup() {
		free(Fields);
...
FlagLookup::FlagLookup() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 4, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[2].fieldinfo(&aDT_CHARARRAY, 132, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
FlagLookup::~FlagLookup() {
		free(Fields);
...
FlagSet::FlagSet() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 24, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 16, 0, 0, 0, 0, 33, &aFlagLookup, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
FlagSet::~FlagSet() {
		free(Fields);
...
ConversationListEntry::ConversationListEntry() {
		...
		Fields[3].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_GBID, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_CHARARRAY, 20, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[6].fieldinfo(&aDT_CHARARRAY, 148, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[7].fieldinfo(&aDT_SNO, 276, 32, 0, 0, 0, 513, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 280, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_SNO, 284, 32, 0, 0, 0, 513, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_SNO, 288, 32, 0, 0, 0, 513, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_SNO, 292, 32, 0, 0, 0, 513, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_SNO, 296, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_SNO, 300, 32, 0, 0, 0, 513, &aDT_NULL, -1);
...
ConversationList::ConversationList() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 24, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 16, 0, 0, 0, 0, 33, &aConversationListEntry, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ConversationList::~ConversationList() {
		free(Fields);
...
ConvLocaleDisplayTimes::ConvLocaleDisplayTimes() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 2);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_FIXEDARRAY, 0, 32, 0, 0, 0, 1, &aDT_INT, 10);
		Fields[2 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ConvLocaleDisplayTimes::~ConvLocaleDisplayTimes() {
		free(Fields);
...
ConversationTreeNode::ConversationTreeNode() {
		...
		Fields[2].fieldinfo(&aDT_INT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FIXEDARRAY, 32, 0, 0, 0, 0, 1, &aConvLocaleDisplayTimes, 18);
		Fields[7].fieldinfo(&aSerializeData, 760, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_CSTRING, 752, 0, 0, 0, 0, 33, &aDT_BYTE, -1);
		Fields[9].fieldinfo(&aDT_ENUM, 12, 4, 0, -1, 8, 17, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_ENUM, 16, 4, 0, -1, 8, 17, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_INT, 768, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aSerializeData, 784, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_VARIABLEARRAY, 776, 0, 0, 0, 0, 33, &aConversationTreeNode, -1);
		Fields[14].fieldinfo(&aSerializeData, 800, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_VARIABLEARRAY, 792, 0, 0, 0, 0, 33, &aConversationTreeNode, -1);
		Fields[16].fieldinfo(&aSerializeData, 816, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_VARIABLEARRAY, 808, 0, 0, 0, 0, 33, &aConversationTreeNode, -1);
		Fields[19 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ConversationTreeNode::~ConversationTreeNode() {
		free(Fields);
}
...
Conversation::Conversation() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 24);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_ENUM, 12, 4, 0, 0, 13, 17, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_SNO, 24, 32, 0, 0, 0, 513, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_SNO, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_SNO, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 44, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_CHARARRAY, 48, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[10].fieldinfo(&aDT_SNO, 176, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_SNO, 180, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_SNO, 184, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_SNO, 188, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_SNO, 192, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_INT, 196, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aSerializeData, 208, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_VARIABLEARRAY, 200, 0, 0, 0, 0, 33, &aConversationTreeNode, -1);
		Fields[18].fieldinfo(&aDT_CHARARRAY, 216, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[19].fieldinfo(&aDT_INT, 472, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aSerializeData, 488, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_VARIABLEARRAY, 480, 0, 0, 0, 0, 32, &aDT_BYTE, -1);
		Fields[22].fieldinfo(&aDT_SNO, 536, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Conversation::~Conversation() {
		free(Fields);
...
Adventure::Adventure() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 7);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_SNO, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_FLOAT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_ANGLE, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_ANGLE, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_ANGLE, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
...
EncounterSpawnOption::EncounterSpawnOption() {
		...
		Fields[0].fieldinfo(&aDT_SNO, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 5, 0, -1, 22, 17, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
EncounterSpawnOption::~EncounterSpawnOption() {
		free(Fields);
...
Encounter::Encounter() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_SNO, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 24, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 16, 0, 0, 0, 0, 33, &aEncounterSpawnOption, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Encounter::~Encounter() {
		free(Fields);
...
MarkerSet::MarkerSet() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 12, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 24, 0, 0, 0, 0, 35, &aMarker, -1);
		Fields[2].fieldinfo(&aSerializeData, 80, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_VARIABLEARRAY, 88, 0, 0, 0, 0, 35, &aCircle, -1);
		Fields[4].fieldinfo(&aDT_INT, 168, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aAABB, 144, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_CHARARRAY, 172, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[7].fieldinfo(&aDT_GBID, 428, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 432, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aSerializeData, 436, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_VARIABLEARRAY, 448, 0, 0, 0, 0, 32, &aDT_WORD, -1);
		Fields[12 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
MarkerSet::~MarkerSet() {
		free(Fields);
...
ScriptFormulaDetails::ScriptFormulaDetails() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 256, 10, 0, 0, 0, 1, &aDT_NULL, 512);
		Fields[2].fieldinfo(&aDT_INT, 768, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 772, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ScriptFormulaDetails::~ScriptFormulaDetails() {
		free(Fields);
...
Power::Power() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 13);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 12, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[1].fieldinfo(&aPowerDef, 80, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 424, 1, 0, 0, 1, 17, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 428, 1, 0, 0, 1, 17, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_CHARARRAY, 432, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[5].fieldinfo(&aDT_INT, 688, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aSerializeData, 692, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_VARIABLEARRAY, 704, 0, 0, 0, 0, 97, &aScriptFormulaDetails, -1);
		Fields[8].fieldinfo(&aDT_INT, 712, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aSerializeData, 728, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_VARIABLEARRAY, 720, 0, 0, 0, 0, 32, &aDT_BYTE, -1);
		Fields[11].fieldinfo(&aDT_SNO, 736, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Power::~Power() {
		free(Fields);
...
StringTableEntry::StringTableEntry() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 8, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_CSTRING, 0, 0, 0, 0, 0, 33, &aDT_BYTE, -1);
		Fields[2].fieldinfo(&aSerializeData, 24, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_CSTRING, 16, 0, 0, 0, 0, 33, &aDT_BYTE, -1);
		Fields[4].fieldinfo(&aSerializeData, 40, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_CSTRING, 32, 0, 0, 0, 0, 33, &aDT_BYTE, -1);
		Fields[6].fieldinfo(&aSerializeData, 56, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_CSTRING, 48, 0, 0, 0, 0, 33, &aDT_BYTE, -1);
		Fields[8].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_INT, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_INT, 72, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
StringTableEntry::~StringTableEntry() {
		free(Fields);
...
StringList::StringList() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 24, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 16, 0, 0, 0, 0, 33, &aStringTableEntry, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
StringList::~StringList() {
		free(Fields);
...
TranslationKey::TranslationKey() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aVector3D, 4, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
TranslationKey::~TranslationKey() {
		free(Fields);
...
RotationKey::RotationKey() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aQuaternion16, 4, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
RotationKey::~RotationKey() {
		free(Fields);
...
TranslationCurve::TranslationCurve() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 4, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 16, 0, 0, 0, 0, 96, &aTranslationKey, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
TranslationCurve::~TranslationCurve() {
		free(Fields);
...
RotationCurve::RotationCurve() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 4, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 16, 0, 0, 0, 0, 96, &aRotationKey, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
RotationCurve::~RotationCurve() {
		free(Fields);
...
ScaleCurve::ScaleCurve() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 4, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 16, 0, 0, 0, 0, 96, &aScaleKey, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ScaleCurve::~ScaleCurve() {
		free(Fields);
...
KeyframedAttachment::KeyframedAttachment() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_FLOAT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aTriggerEvent, 4, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
KeyframedAttachment::~KeyframedAttachment() {
		free(Fields);
...
AnimPermutation::AnimPermutation() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 4, 7, 0, 0, 0, 1, &aDT_NULL, 65);
		Fields[2].fieldinfo(&aDT_VELOCITY, 72, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FLOAT, 76, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 80, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FLOAT, 84, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FLOAT, 88, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_TIME, 92, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_TIME, 96, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 104, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLOAT, 108, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 112, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_FLOAT, 116, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_INT, 100, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_INT, 120, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aSerializeData, 124, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_VARIABLEARRAY, 136, 0, 0, 0, 0, 96, &aBoneName, -1);
		Fields[17].fieldinfo(&aDT_INT, 144, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aSerializeData, 148, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_VARIABLEARRAY, 160, 0, 0, 0, 0, 96, &aTranslationCurve, -1);
		Fields[20].fieldinfo(&aSerializeData, 168, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_VARIABLEARRAY, 176, 0, 0, 0, 0, 96, &aRotationCurve, -1);
		Fields[22].fieldinfo(&aSerializeData, 184, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_VARIABLEARRAY, 192, 0, 0, 0, 0, 96, &aScaleCurve, -1);
		Fields[24].fieldinfo(&aDT_FLOAT, 200, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aDT_FLOAT, 204, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aDT_FLOAT, 208, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aDT_FLOAT, 212, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aVector3D, 216, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[29].fieldinfo(&aVector3D, 228, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[30].fieldinfo(&aVector3D, 240, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[31].fieldinfo(&aVector3D, 252, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[32].fieldinfo(&aDT_FLOAT, 264, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[33].fieldinfo(&aDT_INT, 276, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[34].fieldinfo(&aSerializeData, 268, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[35].fieldinfo(&aDT_VARIABLEARRAY, 280, 0, 0, 0, 0, 97, &aKeyframedAttachment, -1);
		Fields[36].fieldinfo(&aSerializeData, 288, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[37].fieldinfo(&aDT_VARIABLEARRAY, 296, 0, 0, 0, 0, 97, &aVector3D, -1);
		Fields[38].fieldinfo(&aSerializeData, 304, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[39].fieldinfo(&aDT_VARIABLEARRAY, 312, 0, 0, 0, 0, 97, &aVector3D, -1);
		Fields[40].fieldinfo(&aVelocityVector3D, 320, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[41].fieldinfo(&aHardpointLink, 332, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[42].fieldinfo(&aDT_CHARARRAY, 400, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[43].fieldinfo(&aDT_CHARARRAY, 656, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[45 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AnimPermutation::~AnimPermutation() {
		free(Fields);
}
...
Anim::Anim() {
		...
		Fields[2].fieldinfo(&aDT_SNO, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSerializeData, 24, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_VARIABLEARRAY, 40, 0, 0, 0, 0, 33, &aAnimPermutation, -1);
		Fields[6].fieldinfo(&aDT_INT, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Anim::~Anim() {
		free(Fields);
...
AnimSetTagMap::AnimSetTagMap() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_TAGMAP, 8, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AnimSetTagMap::~AnimSetTagMap() {
		free(Fields);
...
AnimSet::AnimSet() {
		...
		Fields[0].fieldinfo(&aDT_SNO, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 16, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_TAGMAP, 24, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FIXEDARRAY, 32, 0, 0, 0, 0, 1, &aAnimSetTagMap, 19);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AnimSet::~AnimSet() {
		free(Fields);
...
ActorCollisionData::ActorCollisionData() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 6);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aActorCollisionFlags, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aAxialCylinder, 20, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aAABB, 40, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ActorCollisionData::~ActorCollisionData() {
		free(Fields);
...
WeightedLook::WeightedLook() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aLookLink, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
WeightedLook::~WeightedLook() {
...
Actor::Actor() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_ENUM, 16, 4, 0, 0, 11, 17, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_SNO, 20, 32, 0, 0, 0, 257, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_SNO, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aAxialCylinder, 28, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aSphere, 48, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aAABB, 64, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aSerializeData, 88, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_TAGMAP, 96, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_SNO, 104, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_SNO, 108, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_INT, 120, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aSerializeData, 112, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_VARIABLEARRAY, 128, 0, 0, 0, 0, 33, &aMsgTriggeredEvent, -1);
		Fields[14].fieldinfo(&aVector3D, 136, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_FIXEDARRAY, 148, 0, 0, 0, 0, 1, &aWeightedLook, 8);
		Fields[16].fieldinfo(&aDT_SNO, 692, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_INT, 696, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_INT, 700, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_FLOAT, 704, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_FLOAT, 708, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_FLOAT, 712, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aActorCollisionData, 716, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_FIXEDARRAY, 784, 0, 0, 0, 0, 1, &aInventoryImages, 5);
		Fields[24].fieldinfo(&aDT_INT, 824, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aSerializeData, 840, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aDT_CSTRING, 832, 0, 0, 0, 0, 33, &aDT_BYTE, -1);
		Fields[27].fieldinfo(&aSerializeData, 856, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aDT_CSTRING, 848, 0, 0, 0, 0, 33, &aDT_BYTE, -1);
		Fields[30 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Actor::~Actor() {
		free(Fields);
}
...
PostFXParams::PostFXParams() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_FIXEDARRAY, 0, 32, 0, 0, 0, 1, &aDT_FLOAT, 4);
		Fields[1].fieldinfo(&aDT_FIXEDARRAY, 16, 32, 0, 0, 0, 1, &aDT_FLOAT, 4);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
PostFXParams::~PostFXParams() {
		free(Fields);
...
Environment::Environment() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 13);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aRGBAColor, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aPostFXParams, 4, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aUberMaterial, 48, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_SNO, 152, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_SNO, 156, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_SNO, 160, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_SNO, 164, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_SNO, 168, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_SNO, 172, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_SNO, 176, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Environment::~Environment() {
		free(Fields);
...
SceneCachedValues::SceneCachedValues() {
		...
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aAABB, 12, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aAABB, 36, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FIXEDARRAY, 60, 32, 0, 0, 0, 1, &aDT_INT, 4);
		Fields[6].fieldinfo(&aDT_INT, 76, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SceneCachedValues::~SceneCachedValues() {
		free(Fields);
...
SceneSpecification::SceneSpecification() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aIVector2D, 4, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FIXEDARRAY, 12, 32, 0, 0, 0, 1, &aDT_SNO, 4);
		Fields[3].fieldinfo(&aDT_SNO, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_SNO, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_SNO, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 44, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_SNO, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_SNO, 52, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_SNO, 56, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_SNO, 60, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_SNO, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_SNO, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_SNO, 72, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_INT, 76, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_INT, 80, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_INT, 84, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_INT, 124, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aSceneCachedValues, 128, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[21 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SceneSpecification::~SceneSpecification() {
		free(Fields);
...
SceneChunk::SceneChunk() {
		...
		Fields[2].fieldinfo(&aSceneSpecification, 36, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SceneChunk::~SceneChunk() {
		free(Fields);
...
SceneParams::SceneParams() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 16, 0, 0, 0, 0, 33, &aSceneChunk, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SceneParams::~SceneParams() {
...
CustomTileCell::CustomTileCell() {
		...
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_SNO, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FIXEDARRAY, 20, 32, 0, 0, 0, 1, &aDT_INT, 4);
		Fields[7 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
CustomTileCell::~CustomTileCell() {
		free(Fields);
...
CustomTileInfo::CustomTileInfo() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 7);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 2, 0, 0, 2, 17, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aIVector2D, 12, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSerializeData, 20, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_VARIABLEARRAY, 32, 0, 0, 0, 0, 33, &aCustomTileCell, -1);
		Fields[7 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
CustomTileInfo::~CustomTileInfo() {
		free(Fields);
...
TileInfo::TileInfo() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_SNO, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSerializeData, 16, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_TAGMAP, 24, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aCustomTileInfo, 32, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
TileInfo::~TileInfo() {
		free(Fields);
...
DRLGCommand::DRLGCommand() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[1].fieldinfo(&aDT_INT, 128, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aSerializeData, 132, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_TAGMAP, 144, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
DRLGCommand::~DRLGCommand() {
		free(Fields);
...
DRLGParams::DRLGParams() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 35, &aTileInfo, -1);
		Fields[2].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aSerializeData, 68, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_VARIABLEARRAY, 80, 0, 0, 0, 0, 33, &aDRLGCommand, -1);
		Fields[5].fieldinfo(&aSerializeData, 88, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_VARIABLEARRAY, 96, 0, 0, 0, 0, 33, &aDT_INT, -1);
		Fields[7].fieldinfo(&aSerializeData, 104, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_TAGMAP, 112, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[10 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
DRLGParams::~DRLGParams() {
		free(Fields);
...
Worlds::Worlds() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 12, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 24, 0, 0, 0, 0, 33, &aDRLGParams, -1);
		Fields[2].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_VARIABLEARRAY, 40, 0, 0, 0, 0, 33, &aSceneParams, -1);
		Fields[4].fieldinfo(&aSerializeData, 48, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_VARIABLEARRAY, 56, 0, 0, 0, 0, 291, &aDT_SNO, -1);
		Fields[6].fieldinfo(&aEnvironment, 112, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aLabelRuleSet, 296, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 320, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aSceneClusterSet, 328, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FIXEDARRAY, 352, 32, 0, 0, 0, 1, &aDT_SNO, 4);
		Fields[11].fieldinfo(&aDT_FLOAT, 372, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_INT, 376, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_SNO, 380, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_INT, 384, 32, 0, 0, 0, 1, &aDT_NULL, -1);
...
NavMeshDef::NavMeshDef() {
		...
		Fields[3].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aSerializeData, 20, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_VARIABLEARRAY, 32, 0, 0, 0, 0, 33, &aNavMeshSquare, -1);
		Fields[7].fieldinfo(&aDT_CHARARRAY, 40, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[9 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
NavMeshDef::~NavMeshDef() {
		free(Fields);
...
NavCell::NavCell() {
		...
		Fields[0].fieldinfo(&aVector3D, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aVector3D, 12, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_WORD, 24, 16, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_WORD, 26, 16, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
NavCell::~NavCell() {
...
NavZoneDefinition::NavZoneDefinition() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 16, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aNavCell, -1);
		Fields[3].fieldinfo(&aDT_INT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSerializeData, 40, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_VARIABLEARRAY, 32, 0, 0, 0, 0, 33, &aNavCellLookup, -1);
		Fields[6].fieldinfo(&aDT_FLOAT, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 52, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 56, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aIVector2D, 60, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aSerializeData, 80, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_VARIABLEARRAY, 72, 0, 0, 0, 0, 33, &aNavGridSquare, -1);
		Fields[12].fieldinfo(&aDT_INT, 88, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aSerializeData, 104, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_VARIABLEARRAY, 96, 0, 0, 0, 0, 33, &aNavCellLookup, -1);
		Fields[15].fieldinfo(&aDT_INT, 112, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aSerializeData, 128, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_VARIABLEARRAY, 120, 0, 0, 0, 0, 33, &aNavCellBorderData, -1);
		Fields[19 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
NavZoneDefinition::~NavZoneDefinition() {
		free(Fields);
...
Scene::Scene() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_SNO, 776, 32, 0, 0, 0, 257, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_SNO, 780, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aAABB, 16, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aAABB, 40, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aNavMeshDef, 64, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aSerializeData, 360, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_VARIABLEARRAY, 368, 0, 0, 0, 0, 291, &aDT_SNO, -1);
		Fields[8].fieldinfo(&aSerializeData, 424, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_VARIABLEARRAY, 432, 0, 0, 0, 0, 291, &aDT_SNO, -1);
		Fields[10].fieldinfo(&aSerializeData, 488, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_VARIABLEARRAY, 496, 0, 0, 0, 0, 291, &aDT_SNO, -1);
		Fields[12].fieldinfo(&aLookLink, 552, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_INT, 624, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aSerializeData, 616, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_VARIABLEARRAY, 632, 0, 0, 0, 0, 33, &aMsgTriggeredEvent, -1);
		Fields[16].fieldinfo(&aNavZoneDefinition, 640, 0, 0, 0, 0, 0, &aDT_NULL, -1);
...
Observer::Observer() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_ANGLE, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FLOAT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_VELOCITY, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_ANGLE, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_ANGLE, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aVector3D, 44, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aVector3D, 56, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLOAT, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 72, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_FLOAT, 76, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_FLOAT, 80, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Observer::~Observer() {
		free(Fields);
...
ActorGroup::ActorGroup() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 4, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ActorGroup::~ActorGroup() {
		free(Fields);
...
GlobalScriptVariable::GlobalScriptVariable() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 4, 6, 0, 0, 0, 1, &aDT_NULL, 32);
		Fields[2].fieldinfo(&aDT_FLOAT, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
GlobalScriptVariable::~GlobalScriptVariable() {
		free(Fields);
...
BannerColorSet::BannerColorSet() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_FIXEDARRAY, 0, 0, 0, 0, 0, 1, &aRGBAColor, 2);
		Fields[1].fieldinfo(&aDT_INT, 8, 1, 0, 0, 1, 17, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_CHARARRAY, 12, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
BannerColorSet::~BannerColorSet() {
		free(Fields);
...
BannerParams::BannerParams() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 8, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 0, 0, 0, 0, 0, 33, &aBannerTexturePair, -1);
		Fields[2].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_VARIABLEARRAY, 24, 0, 0, 0, 0, 33, &aBannerTexturePair, -1);
		Fields[5].fieldinfo(&aDT_INT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aSerializeData, 56, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_VARIABLEARRAY, 48, 0, 0, 0, 0, 33, &aBannerTexturePair, -1);
		Fields[8].fieldinfo(&aSerializeData, 72, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_VARIABLEARRAY, 64, 0, 0, 0, 0, 33, &aBannerTexturePair, -1);
		Fields[10].fieldinfo(&aDT_INT, 80, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aSerializeData, 96, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_VARIABLEARRAY, 88, 0, 0, 0, 0, 33, &aBannerTexturePair, -1);
		Fields[13].fieldinfo(&aDT_INT, 104, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aSerializeData, 120, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_VARIABLEARRAY, 112, 0, 0, 0, 0, 33, &aBannerColorSet, -1);
		Fields[16].fieldinfo(&aSerializeData, 136, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_VARIABLEARRAY, 128, 0, 0, 0, 0, 33, &aDT_SNO, -1);
		Fields[18].fieldinfo(&aSerializeData, 152, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_VARIABLEARRAY, 144, 0, 0, 0, 0, 33, &aDT_SNO, -1);
		Fields[20].fieldinfo(&aSerializeData, 168, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_VARIABLEARRAY, 160, 0, 0, 0, 0, 33, &aDT_SNO, -1);
		Fields[22].fieldinfo(&aSerializeData, 184, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_VARIABLEARRAY, 176, 0, 0, 0, 0, 33, &aDT_SNO, -1);
		Fields[25 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
BannerParams::~BannerParams() {
		free(Fields);
...
Globals::Globals() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 54);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 12, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[1].fieldinfo(&aDT_FIXEDARRAY, 268, 0, 0, 0, 0, 1, &aDifficultyTuningParams, 4);
		Fields[2].fieldinfo(&aDT_FLOAT, 380, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FLOAT, 384, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 388, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FLOAT, 460, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_INT, 392, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 456, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_FLOAT, 464, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 468, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLOAT, 472, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_INT, 2076, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_INT, 2080, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_INT, 2084, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_INT, 2088, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_FLOAT, 2092, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_FLOAT, 2096, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_INT, 2100, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_FLOAT, 2104, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_FLOAT, 2108, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_FLOAT, 2112, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_FLOAT, 2116, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_FLOAT, 2120, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_INT, 2132, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aDT_INT, 2136, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aDT_FLOAT, 2124, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aDT_FLOAT, 2128, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aDT_FLOAT, 2140, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aDT_FLOAT, 2144, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[29].fieldinfo(&aDT_FLOAT, 2148, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[30].fieldinfo(&aDT_FLOAT, 2152, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[31].fieldinfo(&aDT_FLOAT, 2156, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[32].fieldinfo(&aDT_INT, 2160, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[33].fieldinfo(&aDT_FIXEDARRAY, 2164, 32, 0, 0, 0, 1, &aDT_INT, 4);
		Fields[34].fieldinfo(&aDT_FIXEDARRAY, 476, 0, 0, 0, 0, 1, &aRGBAColor, 400);
		Fields[35].fieldinfo(&aSerializeData, 408, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[36].fieldinfo(&aDT_VARIABLEARRAY, 400, 0, 0, 0, 0, 33, &aActorGroup, -1);
		Fields[37].fieldinfo(&aDT_INT, 416, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[38].fieldinfo(&aSerializeData, 432, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[39].fieldinfo(&aDT_VARIABLEARRAY, 424, 0, 0, 0, 0, 33, &aStartLocationName, -1);
		Fields[40].fieldinfo(&aSerializeData, 448, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[41].fieldinfo(&aDT_VARIABLEARRAY, 440, 0, 0, 0, 0, 33, &aGlobalScriptVariable, -1);
		Fields[42].fieldinfo(&aBannerParams, 2184, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[43].fieldinfo(&aDT_INT, 2376, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[44].fieldinfo(&aDT_INT, 2380, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[45].fieldinfo(&aDT_INT, 2384, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[46].fieldinfo(&aDT_INT, 2388, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[47].fieldinfo(&aDT_INT, 2392, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[48].fieldinfo(&aDT_FLOAT, 2396, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[49].fieldinfo(&aDT_FLOAT, 2400, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[50].fieldinfo(&aDT_FLOAT, 2404, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[51].fieldinfo(&aDT_FLOAT, 2408, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[52].fieldinfo(&aDT_FLOAT, 2412, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[54 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Globals::~Globals() {
		free(Fields);
...
dmMeshNode::dmMeshNode() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_WORD, 4, 16, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_WORD, 6, 16, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_BYTE, 8, 8, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_BYTE, 9, 8, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
dmMeshNode::~dmMeshNode() {
		free(Fields);
...
dmMeshTriangle::dmMeshTriangle() {
		...
		Fields[4].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_WORD, 24, 16, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
dmMeshTriangle::~dmMeshTriangle() {
		free(Fields);
...
dmPlane::dmPlane() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&admFloat3, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_FLOAT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
dmPlane::~dmPlane() {
...
CollisionMesh::CollisionMesh() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&admFloat3, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&admFloat3, 12, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&admFloat3, 24, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 76, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSerializeData, 96, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_VARIABLEARRAY, 48, 0, 0, 0, 0, 33, &admFloat3, -1);
		Fields[6].fieldinfo(&aDT_INT, 80, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aSerializeData, 104, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_VARIABLEARRAY, 56, 0, 0, 0, 0, 33, &admMeshTriangle, -1);
		Fields[9].fieldinfo(&aDT_INT, 84, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aSerializeData, 120, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_VARIABLEARRAY, 64, 0, 0, 0, 0, 33, &admMeshEdge, -1);
		Fields[12].fieldinfo(&aDT_INT, 72, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aSerializeData, 112, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_VARIABLEARRAY, 40, 0, 0, 0, 0, 33, &admMeshNode, -1);
		Fields[15].fieldinfo(&aDT_INT, 88, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_INT, 92, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_INT, 128, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_INT, 132, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
CollisionMesh::~CollisionMesh() {
		free(Fields);
...
PhysMesh::PhysMesh() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aSerializeData, 20, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_VARIABLEARRAY, 32, 0, 0, 0, 0, 32, &aCollisionMesh, -1);
		Fields[4].fieldinfo(&aDT_CHARARRAY, 44, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[5].fieldinfo(&aDT_CHARARRAY, 300, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[6].fieldinfo(&aDT_INT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
PhysMesh::~PhysMesh() {
		free(Fields);
...
MarkerLink::MarkerLink() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 128, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
MarkerLink::~MarkerLink() {
		free(Fields);
...
Marker::Marker() {
		...
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[1].fieldinfo(&aDT_INT, 128, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aPRTransform, 132, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aSNOName, 160, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSerializeData, 168, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_TAGMAP, 176, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_INT, 184, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aSerializeData, 188, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_VARIABLEARRAY, 200, 0, 0, 0, 0, 33, &aMarkerLink, -1);
		Fields[10 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Marker::~Marker() {
		free(Fields);
...
GameErrorData::GameErrorData() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 7, 0, 0, 81, 17, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
GameErrorData::~GameErrorData() {
...
HeroStateData::HeroStateData() {
		...
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 12, 29, 0, 0, 536870911, 17, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aPlayerSavedData, 16, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 2828, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FIXEDARRAY, 2832, 0, 7, 0, 0, 8, &aPlayerQuestRewardHistoryEntry, 100);
		Fields[8 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
HeroStateData::~HeroStateData() {
		free(Fields);
...
SNOName::SNOName() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_SNO_GROUP, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_SNONAME_HANDLE, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SNOName::~SNOName() {
		free(Fields);
...
TryConsoleCommand::TryConsoleCommand() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aRequiredMessageHeader, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 12, 10, 0, 0, 0, 1, &aDT_NULL, 512);
		Fields[2].fieldinfo(&aDT_INT, 8, 4, 0, -1, 7, 17, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aWorldPlace, 524, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 540, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
TryConsoleCommand::~TryConsoleCommand() {
		free(Fields);
...
PlayerLevel::PlayerLevel() {
		...
		Fields[0].fieldinfo(&aRequiredMessageHeader, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 8, 3, 0, 0, 7, 17, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 12, 7, 0, 0, 127, 17, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
PlayerLevel::~PlayerLevel() {
		free(Fields);
...
VisualItem::VisualItem() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_GBID, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 5, 0, 0, 21, 17, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 4, 0, 0, 14, 17, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 12, 5, 0, -1, 30, 17, &aDT_NULL, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
VisualItem::~VisualItem() {
		free(Fields);
...
VisualEquipment::VisualEquipment() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 2);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_FIXEDARRAY, 0, 0, 0, 0, 0, 1, &aVisualItem, 8);
		Fields[2 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
VisualEquipment::~VisualEquipment() {
		free(Fields);
...
NPCInteraction::NPCInteraction() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 5);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 4, 0, 0, 8, 17, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 12, 2, 0, 0, 3, 17, &aDT_NULL, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
NPCInteraction::~NPCInteraction() {
		free(Fields);
...
NetAttributeKeyValue::NetAttributeKeyValue() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_OPTIONAL, 0, 20, 0, 0, 1048575, 17, &aDT_INT, -1);
		Fields[1].fieldinfo(&aDT_INT, 8, 10, 0, 0, 709, 17, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
NetAttributeKeyValue::~NetAttributeKeyValue() {
		free(Fields);
...
LabelCondition::LabelCondition() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_ENUM, 0, 2, 0, 0, 2, 17, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FIXEDARRAY, 8, 32, 0, 0, 0, 1, &aDT_INT, 4);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
LabelCondition::~LabelCondition() {
		free(Fields);
...
LabelRule::LabelRule() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[1].fieldinfo(&aLabelCondition, 128, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 152, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 156, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSerializeData, 168, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_VARIABLEARRAY, 160, 0, 0, 0, 0, 33, &aLabelEntry, -1);
		Fields[7 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
LabelRule::~LabelRule() {
		free(Fields);
...
LabelRuleSet::LabelRuleSet() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 16, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aLabelRule, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
LabelRuleSet::~LabelRuleSet() {
		free(Fields);
...
NavMeshConnectedSquare::NavMeshConnectedSquare() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 5);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aNavMeshSquare, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_FIXEDARRAY, 8, 32, 0, 0, 0, 1, &aDT_INT, 4);
		Fields[2].fieldinfo(&aDT_INT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
...
GizmoLocSpawnEntry::GizmoLocSpawnEntry() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aSNOName, 8, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
GizmoLocSpawnEntry::~GizmoLocSpawnEntry() {
...
GizmoLocSpawnType::GizmoLocSpawnType() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 8, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 0, 0, 0, 0, 0, 33, &aGizmoLocSpawnEntry, -1);
		Fields[2].fieldinfo(&aDT_CHARARRAY, 16, 7, 0, 0, 0, 1, &aDT_NULL, 80);
		Fields[3].fieldinfo(&aDT_CHARARRAY, 96, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
GizmoLocSpawnType::~GizmoLocSpawnType() {
		free(Fields);
...
GizmoLocSet::GizmoLocSet() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 2);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_FIXEDARRAY, 0, 0, 0, 0, 0, 1, &aGizmoLocSpawnType, 26);
		Fields[2 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
GizmoLocSet::~GizmoLocSet() {
		free(Fields);
...
BuffDef::BuffDef() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aSerializeData, 0, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aDT_SNO, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
BuffDef::~BuffDef() {
		free(Fields);
...
PowerDef::PowerDef() {
		...
		Fields[1].fieldinfo(&aDT_TAGMAP, 8, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aSerializeData, 16, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_TAGMAP, 24, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_TAGMAP, 40, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aSerializeData, 48, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_TAGMAP, 80, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aSerializeData, 56, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_TAGMAP, 88, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aSerializeData, 64, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_TAGMAP, 96, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aSerializeData, 72, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_TAGMAP, 104, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aSerializeData, 112, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_TAGMAP, 144, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aSerializeData, 120, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_TAGMAP, 152, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aSerializeData, 128, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_TAGMAP, 160, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aSerializeData, 136, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_TAGMAP, 168, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_INT, 176, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aActorCollisionFlags, 180, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aActorCollisionFlags, 196, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aBuffDef, 216, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aBuffDef, 232, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aBuffDef, 248, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aBuffDef, 264, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[30 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
PowerDef::~PowerDef() {
		free(Fields);
...
TriggerConditions::TriggerConditions() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 10);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_PERCENT, 0, 8, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_TIME, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_TIME, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_TIME, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_TIME, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_IMPULSE, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_IMPULSE, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
...
Hardpoint::Hardpoint() {
		...
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[1].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aPRTransform, 68, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Hardpoint::~Hardpoint() {
		free(Fields);
...
TriggerEvent::TriggerEvent() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aTriggerConditions, 4, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aSNOName, 44, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 52, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 56, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FIXEDARRAY, 68, 0, 0, 0, 0, 1, &aHardpointLink, 2);
		Fields[7].fieldinfo(&aLookLink, 204, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aConstraintLink, 268, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_INT, 332, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLOAT, 336, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_INT, 340, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_INT, 344, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_INT, 348, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_INT, 352, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_INT, 356, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_FLOAT, 360, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_FLOAT, 364, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_INT, 384, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_INT, 368, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_FLOAT, 372, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_INT, 376, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_VELOCITY, 380, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_TIME, 388, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aDT_INT, 60, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aRGBAColor, 392, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aDT_TIME, 396, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aRGBAColor, 400, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[29].fieldinfo(&aDT_TIME, 404, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[31 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
TriggerEvent::~TriggerEvent() {
		free(Fields);
...
VelocityVector3D::VelocityVector3D() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_VELOCITY, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_VELOCITY, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VELOCITY, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
VelocityVector3D::~VelocityVector3D() {
		free(Fields);
...
AccelVector3D::AccelVector3D() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_ACCEL, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_ACCEL, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_ACCEL, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AccelVector3D::~AccelVector3D() {
		free(Fields);
...
ImpulseVector3D::ImpulseVector3D() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_IMPULSE, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_IMPULSE, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_IMPULSE, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ImpulseVector3D::~ImpulseVector3D() {
		free(Fields);
...
SubSceneEntry::SubSceneEntry() {
		...
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aSerializeData, 24, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_VARIABLEARRAY, 16, 0, 0, 0, 0, 33, &aSubSceneLabel, -1);
		Fields[6 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SubSceneEntry::~SubSceneEntry() {
		free(Fields);
...
SubSceneGroup::SubSceneGroup() {
		...
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aSerializeData, 16, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aSubSceneEntry, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SubSceneGroup::~SubSceneGroup() {
		free(Fields);
...
SceneCluster::SceneCluster() {
		...
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[1].fieldinfo(&aDT_INT, 128, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 132, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aSerializeData, 144, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_VARIABLEARRAY, 136, 0, 0, 0, 0, 33, &aSubSceneGroup, -1);
		Fields[5].fieldinfo(&aSubSceneGroup, 152, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SceneCluster::~SceneCluster() {
		free(Fields);
...
SceneClusterSet::SceneClusterSet() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 16, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 33, &aSceneCluster, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SceneClusterSet::~SceneClusterSet() {
		free(Fields);
...
PlayLineParams::PlayLineParams() {
		...
		Fields[0].fieldinfo(&aDT_SNO, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 8, 1, 0, 0, 1, 17, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_INT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_SNO, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_CHARARRAY, 44, 6, 0, 0, 0, 1, &aDT_NULL, 49);
		Fields[11].fieldinfo(&aDT_INT, 96, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_INT, 100, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_INT, 104, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_INT, 108, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_INT, 112, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
PlayLineParams::~PlayLineParams() {
...
VertInfluences::VertInfluences() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 2);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_FIXEDARRAY, 0, 0, 0, 0, 0, 1, &aInfluence, 3);
		Fields[2 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
VertInfluences::~VertInfluences() {
		free(Fields);
...
FatVertex::FatVertex() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aVector3D, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aRGBAColor, 12, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FIXEDARRAY, 16, 0, 0, 0, 0, 1, &aRGBAColor, 2);
		Fields[3].fieldinfo(&aDT_FIXEDARRAY, 24, 0, 0, 0, 0, 1, &aRGBAColor, 2);
		Fields[4].fieldinfo(&aRGBAColor, 32, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aRGBAColor, 36, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_WORD, 40, 16, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
FatVertex::~FatVertex() {
		free(Fields);
...
PolytopeData::PolytopeData() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 15);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&admFloat3, 32, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 64, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 0, 0, 0, 0, 0, 1, &admFloat3, -1);
		Fields[3].fieldinfo(&aSerializeData, 72, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_VARIABLEARRAY, 8, 0, 0, 0, 0, 1, &admPlane, -1);
		Fields[5].fieldinfo(&aSerializeData, 80, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_VARIABLEARRAY, 16, 0, 0, 0, 0, 1, &admSubEdge, -1);
		Fields[7].fieldinfo(&aSerializeData, 88, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_VARIABLEARRAY, 24, 0, 0, 0, 0, 1, &aDT_BYTE, -1);
		Fields[9].fieldinfo(&aDT_INT, 44, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_INT, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_INT, 52, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_FLOAT, 56, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_FLOAT, 60, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
PolytopeData::~PolytopeData() {
		free(Fields);
...
CollisionShape::CollisionShape() {
		...
		Fields[5].fieldinfo(&aDT_FLOAT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FLOAT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aSerializeData, 28, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_VARIABLEARRAY, 36, 0, 0, 0, 0, 1, &aPolytopeData, -1);
		Fields[9].fieldinfo(&aVector3D, 40, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aVector3D, 52, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
CollisionShape::~CollisionShape() {
		free(Fields);
...
CollisionCapsule::CollisionCapsule() {
		...
		Fields[0].fieldinfo(&aDT_FLOAT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_FLOAT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aHardpoint, 8, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
CollisionCapsule::~CollisionCapsule() {
		free(Fields);
...
ClothVertex::ClothVertex() {
		...
		Fields[1].fieldinfo(&aVector3D, 12, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aVector3D, 24, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aVector3D, 36, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 52, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_INT, 56, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 60, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aVector3D, 68, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_INT, 80, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ClothVertex::~ClothVertex() {
...
ClothStaple::ClothStaple() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_FIXEDARRAY, 4, 32, 0, 0, 0, 1, &aDT_INT, 3);
		Fields[2].fieldinfo(&aDT_FIXEDARRAY, 16, 32, 0, 0, 0, 1, &aDT_FLOAT, 3);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ClothStaple::~ClothStaple() {
		free(Fields);
...
ClothStructure::ClothStructure() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 4, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 12, 0, 0, 0, 0, 1, &aClothVertex, -1);
		Fields[3].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSerializeData, 20, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 1, &aClothFace, -1);
		Fields[6].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aSerializeData, 36, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_VARIABLEARRAY, 44, 0, 0, 0, 0, 1, &aClothStaple, -1);
		Fields[9].fieldinfo(&aDT_INT, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aSerializeData, 52, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_VARIABLEARRAY, 60, 0, 0, 0, 0, 1, &aClothConstraint, -1);
		Fields[12].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aSerializeData, 68, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_VARIABLEARRAY, 76, 0, 0, 0, 0, 1, &aClothConstraint, -1);
		Fields[15].fieldinfo(&aDT_INT, 80, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_FLOAT, 84, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ClothStructure::~ClothStructure() {
...
SubObject::SubObject() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aSerializeData, 8, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_VARIABLEARRAY, 16, 0, 0, 0, 0, 0, &aFatVertex, -1);
		Fields[4].fieldinfo(&aSerializeData, 20, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 0, &aVertInfluences, -1);
		Fields[6].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aSerializeData, 36, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_VARIABLEARRAY, 44, 0, 0, 0, 0, 0, &aDT_WORD, -1);
		Fields[9].fieldinfo(&aSerializeData, 48, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_VARIABLEARRAY, 56, 0, 0, 0, 0, 0, &aClothStructure, -1);
		Fields[11].fieldinfo(&aDT_SNO, 60, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_FLOAT, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_CHARARRAY, 72, 8, 0, 0, 0, 0, &aDT_NULL, 128);
		Fields[15].fieldinfo(&aDT_CHARARRAY, 200, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[16].fieldinfo(&aAABB, 328, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_INT, 352, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aSerializeData, 356, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_VARIABLEARRAY, 364, 0, 0, 0, 0, 0, &aCollisionShape, -1);
		Fields[21 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SubObject::~SubObject() {
		free(Fields);
...
BoneStructure::BoneStructure() {
		...
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[1].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aAABB, 68, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aSphere, 92, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aPRSTransform, 108, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aPRSTransform, 140, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aPRSTransform, 172, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 204, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aSerializeData, 208, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_VARIABLEARRAY, 216, 0, 0, 0, 0, 1, &aCollisionShape, -1);
		Fields[10].fieldinfo(&aSerializeData, 220, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_VARIABLEARRAY, 228, 0, 0, 0, 0, 1, &aConstraintParameters, -1);
		Fields[12].fieldinfo(&aDT_SNO, 232, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
BoneStructure::~BoneStructure() {
		free(Fields);
...
LookAtData::LookAtData() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 4, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[2].fieldinfo(&aDT_ANGLE, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_ANGLE, 72, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_ANGLE, 76, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_ANGLE, 80, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_ANGULARVELOCITY, 84, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 88, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
LookAtData::~LookAtData() {
		free(Fields);
...
BonePulseData::BonePulseData() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[1].fieldinfo(&aDT_FLOAT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_ANGLE, 72, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
BonePulseData::~BonePulseData() {
...
GeoSet::GeoSet() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 4, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 16, 0, 0, 0, 0, 33, &aSubObject, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
GeoSet::~GeoSet() {
		free(Fields);
...
Structure::Structure() {
		...
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aSerializeData, 8, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_VARIABLEARRAY, 16, 0, 0, 0, 0, 32, &aBoneStructure, -1);
		Fields[4].fieldinfo(&aLookAtData, 24, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 116, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aSerializeData, 128, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_VARIABLEARRAY, 120, 0, 0, 0, 0, 33, &aBonePulseData, -1);
		Fields[8].fieldinfo(&aDT_FIXEDARRAY, 136, 0, 0, 0, 0, 1, &aGeoSet, 2);
		Fields[9].fieldinfo(&aSphere, 184, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_INT, 200, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aSerializeData, 204, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_VARIABLEARRAY, 216, 0, 0, 0, 0, 32, &aCollisionCapsule, -1);
		Fields[13].fieldinfo(&aDT_INT, 224, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aSerializeData, 228, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_VARIABLEARRAY, 240, 0, 0, 0, 0, 32, &aHardpoint, -1);
		Fields[16].fieldinfo(&aVector3D, 248, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aOctree, 264, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aAABB, 336, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_CHARARRAY, 400, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[20].fieldinfo(&aDT_CHARARRAY, 656, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[21].fieldinfo(&aDT_CHARARRAY, 912, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[22].fieldinfo(&aDT_CHARARRAY, 1168, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[23].fieldinfo(&aDT_INT, 1424, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aDT_FLOAT, 1428, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aDT_INT, 1432, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aDT_INT, 360, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aSerializeData, 364, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aDT_VARIABLEARRAY, 376, 0, 0, 0, 0, 32, &aConstraintParameters, -1);
		Fields[29].fieldinfo(&aDT_INT, 384, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[31 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Structure::~Structure() {
		free(Fields);
...
SubObjectAppearance::SubObjectAppearance() {
		...
		Fields[1].fieldinfo(&aDT_SNO, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aSerializeData, 8, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_TAGMAP, 16, 0, 0, 0, 0, 33, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aUberMaterial, 24, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_SNO, 128, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SubObjectAppearance::~SubObjectAppearance() {
		free(Fields);
...
AppearanceMaterial::AppearanceMaterial() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[1].fieldinfo(&aSerializeData, 128, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 136, 0, 0, 0, 0, 1, &aSubObjectAppearance, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AppearanceMaterial::~AppearanceMaterial() {
		free(Fields);
...
StaticLight::StaticLight() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aVector3D, 8, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aVector3D, 20, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 32, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 36, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FIXEDARRAY, 40, 32, 0, 0, 0, 0, &aDT_FLOAT, 3);
		Fields[7].fieldinfo(&aDT_FLOAT, 52, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_FLOAT, 56, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 60, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLOAT, 64, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_INT, 68, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_INT, 72, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aRGBAColorValue, 76, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[15 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
StaticLight::~StaticLight() {
		free(Fields);
...
Appearance::Appearance() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 23);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 1460, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 1464, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 1472, 0, 0, 0, 0, 33, &aAppearanceMaterial, -1);
		Fields[3].fieldinfo(&aSerializeData, 1480, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_VARIABLEARRAY, 1488, 0, 0, 0, 0, 33, &aAppearanceLook, -1);
		Fields[5].fieldinfo(&aStructure, 16, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_INT, 1456, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 1496, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aSerializeData, 1500, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_VARIABLEARRAY, 1512, 0, 0, 0, 0, 33, &aStaticLight, -1);
		Fields[10].fieldinfo(&aDT_INT, 1520, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_TIME, 1524, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_TIME, 1528, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_TIME, 1532, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_TIME, 1536, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_TIME, 1540, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_INT, 1544, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_FLOAT, 1548, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_INT, 1552, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_INT, 1556, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_INT64, 1560, 64, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_INT, 1568, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Appearance::~Appearance() {
		free(Fields);
...
Reverb::Reverb() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 2);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aReverbParams, 12, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Reverb::~Reverb() {
		free(Fields);
...
Material::Material() {
		...
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 16, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_TAGMAP, 24, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aUberMaterial, 32, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Material::~Material() {
		free(Fields);
...
Shakes::Shakes() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_TIME, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_TIME, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FLOAT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aVectorPath, 32, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aVectorPath, 72, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aAnglePath, 112, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aFloatPath, 152, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aAnglePath, 192, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aFloatPath, 232, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aAnglePath, 272, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aFloatPath, 312, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Shakes::~Shakes() {
		free(Fields);
...
WeatherStateParams::WeatherStateParams() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aRGBAColor, 4, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FLOAT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aRGBAColor, 16, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FLOAT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FLOAT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_SNO, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_SNO, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLOAT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_SNO, 44, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_SNO, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_SNO, 52, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
WeatherStateParams::~WeatherStateParams() {
		free(Fields);
...
Weather::Weather() {
		...
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_TIME, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aVelocityVectorPath, 20, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aVelocityVectorPath, 60, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_TIME, 100, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aFloatPath, 104, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_SNO, 144, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_SNO, 148, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_SNO, 152, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 156, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_TIME, 160, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_TIME, 164, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_TIME, 168, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_SNO, 172, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_SNO, 176, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_FLOAT, 180, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_FLOAT, 184, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_FLOAT, 188, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aWeatherStateParams, 192, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aWeatherStateParams, 248, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_FLOAT, 304, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aColorCorrectionParams, 308, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Weather::~Weather() {
		free(Fields);
...
Rope::Rope() {
		...
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_MASS, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_MASS, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FLOAT, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aUberMaterial, 48, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_SNO, 152, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_TIME, 156, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_TIME, 160, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_TIME, 164, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_TIME, 168, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aColorPath, 172, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aColorPath, 212, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aFloatPath, 252, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aFloatPath, 292, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aFloatPath, 332, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aFloatPath, 372, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aFloatPath, 412, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aFloatPath, 452, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aFloatPath, 492, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aFloatPath, 532, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aFloatPath, 572, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aFloatPath, 612, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aVectorPath, 652, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aVelocityPath, 692, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aDT_FLOAT, 732, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[29].fieldinfo(&aDT_FLOAT, 736, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[30].fieldinfo(&aFloatPath, 740, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[31].fieldinfo(&aFloatPath, 780, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[32].fieldinfo(&aFloatPath, 820, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[33].fieldinfo(&aFloatPath, 860, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[34].fieldinfo(&aFloatPath, 900, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[35].fieldinfo(&aDT_INT, 948, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[36].fieldinfo(&aSerializeData, 940, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[37].fieldinfo(&aDT_VARIABLEARRAY, 952, 0, 0, 0, 0, 1, &aMsgTriggeredEvent, -1);
		Fields[39 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Rope::~Rope() {
		free(Fields);
}
...
PlaylistEntry::PlaylistEntry() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_SNO, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 4, 8, 0, 0, 0, 1, &aDT_NULL, 129);
		Fields[2].fieldinfo(&aDT_FLOAT, 136, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 140, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 144, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 148, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_INT, 152, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 156, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 160, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_INT, 164, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_TIME, 168, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_INT, 172, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_TIME, 176, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
PlaylistEntry::~PlaylistEntry() {
		free(Fields);
...
Music::Music() {
		...
		Fields[1].fieldinfo(&aDT_FLOAT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_TIME, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_TIME, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aSerializeData, 28, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_VARIABLEARRAY, 40, 0, 0, 0, 0, 1, &aPlaylistEntry, -1);
		Fields[7].fieldinfo(&aDT_FIXEDARRAY, 44, 0, 0, 0, 0, 1, &aRandomMusicSoundParams, 2);
		Fields[9 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Music::~Music() {
		free(Fields);
...
SoundPermutation::SoundPermutation() {
		...
		Fields[0].fieldinfo(&aDT_SNO, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 4, 8, 0, 0, 0, 1, &aDT_NULL, 129);
		Fields[2].fieldinfo(&aDT_INT, 136, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FLOAT, 140, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 144, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FLOAT, 148, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FLOAT, 152, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_TIME, 156, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_TIME, 160, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SoundPermutation::~SoundPermutation() {
		free(Fields);
...
Sound::Sound() {
		...
		Fields[6].fieldinfo(&aDT_FLOAT, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_FLOAT, 44, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_IMPULSE, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_IMPULSE, 52, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 56, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_FLOAT, 60, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_INT, 72, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aSerializeData, 64, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_VARIABLEARRAY, 76, 0, 0, 0, 0, 1, &aSoundPermutation, -1);
		Fields[16].fieldinfo(&aDT_INT, 80, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_INT, 84, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_TIME, 100, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aSerializeData, 92, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_VARIABLEARRAY, 88, 0, 0, 0, 0, 1, &aDspEffect, -1);
		Fields[22 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Sound::~Sound() {
		free(Fields);
}
...
SoundSample::SoundSample() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 11);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 8, 0, 0, 0, 1, &aDT_NULL, 129);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 385, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[2].fieldinfo(&aDT_INT, 644, 1, 0, 0, 1, 17, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 648, 1, 0, 0, 1, 17, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 652, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 656, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_INT, 660, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 664, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aSerializeData, 668, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_CHARARRAY, 129, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[11 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SoundSample::~SoundSample() {
		free(Fields);
...
SoundBank::SoundBank() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 7);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 12, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 24, 0, 0, 0, 0, 1, &aSoundSample, -1);
		Fields[3].fieldinfo(&aSerializeData, 28, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_VARIABLEARRAY, 36, 0, 0, 0, 0, 1, &aDT_INT64, -1);
		Fields[5].fieldinfo(&aDT_INT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
SoundBank::~SoundBank() {
...
LightStateParams::LightStateParams() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 12);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aFloatPath, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aFloatPath, 40, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FIXEDARRAY, 80, 0, 0, 0, 0, 1, &aFloatPath, 3);
		Fields[3].fieldinfo(&aAnglePath, 200, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aAnglePath, 240, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aColorPath, 280, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aFloatPath, 320, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aColorPath, 360, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aFloatPath, 400, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aColorPath, 440, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aFloatPath, 480, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
LightStateParams::~LightStateParams() {
		free(Fields);
...
Light::Light() {
		...
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aMaterialTexture, 24, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_TIME, 204, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 208, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FLOAT, 212, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aLightStateParams, 216, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aLightStateParams, 736, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Light::~Light() {
		free(Fields);
...
UIControlElement::UIControlElement() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 4, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
UIControlElement::~UIControlElement() {
		free(Fields);
...
DataElements::DataElements() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 4, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 12, 0, 0, 0, 0, 0, &aUIControlElement, -1);
		Fields[3].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSerializeData, 20, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 0, &aUIDataElementInt32, -1);
		Fields[6].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aSerializeData, 36, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_VARIABLEARRAY, 44, 0, 0, 0, 0, 0, &aUIDataElementFloat32, -1);
		Fields[10 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
DataElements::~DataElements() {
		free(Fields);
...
UIStyleChildSpec::UIStyleChildSpec() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 3);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 10, 0, 0, 0, 1, &aDT_NULL, 512);
		Fields[1].fieldinfo(&aDataElements, 512, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
UIStyleChildSpec::~UIStyleChildSpec() {
		free(Fields);
...
UIStyle::UIStyle() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 4, 10, 0, 0, 0, 1, &aDT_NULL, 512);
		Fields[2].fieldinfo(&aDataElements, 516, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 564, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSerializeData, 568, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_VARIABLEARRAY, 576, 0, 0, 0, 0, 0, &aUIStyleChildSpec, -1);
		Fields[7 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
UIStyle::~UIStyle() {
		free(Fields);
...
UIAnimationElementVector2D::UIAnimationElementVector2D() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_FLOAT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_FIXEDARRAY, 4, 32, 0, 0, 0, 1, &aDT_FLOAT, 2);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
UIAnimationElementVector2D::~UIAnimationElementVector2D() {
		free(Fields);
...
UIAnimationDescription::UIAnimationDescription() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 4, 10, 0, 0, 0, 1, &aDT_NULL, 512);
		Fields[2].fieldinfo(&aDT_INT, 516, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FIXEDARRAY, 520, 32, 0, 0, 0, 1, &aDT_INT, 2);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
UIAnimationDescription::~UIAnimationDescription() {
		free(Fields);
...
UIControlAnimationBinding::UIControlAnimationBinding() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 10, 0, 0, 0, 1, &aDT_NULL, 512);
		Fields[1].fieldinfo(&aDT_INT, 512, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
UIControlAnimationBinding::~UIControlAnimationBinding() {
		free(Fields);
...
UIAnimationElements::UIAnimationElements() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 4, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 12, 0, 0, 0, 0, 0, &aUIAnimationElementInt32, -1);
		Fields[3].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSerializeData, 20, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 0, &aUIAnimationElementFloat, -1);
		Fields[6].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aSerializeData, 36, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_VARIABLEARRAY, 44, 0, 0, 0, 0, 0, &aUIAnimationElementVector2D, -1);
		Fields[9].fieldinfo(&aDT_INT, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aSerializeData, 52, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_VARIABLEARRAY, 60, 0, 0, 0, 0, 0, &aUIAnimationDescription, -1);
		Fields[12].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aSerializeData, 68, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_VARIABLEARRAY, 76, 0, 0, 0, 0, 0, &aUIControlAnimationBinding, -1);
		Fields[16 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
UIAnimationElements::~UIAnimationElements() {
		free(Fields);
...
UIControlData::UIControlData() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_CHARARRAY, 8, 10, 0, 0, 0, 1, &aDT_NULL, 512);
		Fields[3].fieldinfo(&aDT_INT, 520, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_CHARARRAY, 524, 10, 0, 0, 0, 1, &aDT_NULL, 512);
		Fields[5].fieldinfo(&aDT_INT, 1036, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aUIStyle, 1040, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aUIAnimationElements, 1640, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
UIControlData::~UIControlData() {
		free(Fields);
...
UI::UI() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 12, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 268, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[2].fieldinfo(&aDT_INT, 524, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 528, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aSerializeData, 532, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_VARIABLEARRAY, 540, 0, 0, 0, 0, 0, &aUIControlData, -1);
		Fields[6].fieldinfo(&aDT_INT, 544, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aSerializeData, 548, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_VARIABLEARRAY, 556, 0, 0, 0, 0, 0, &aUIStyle, -1);
		Fields[9].fieldinfo(&aDataElements, 560, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
UI::~UI() {
		free(Fields);
...
RenderParams::RenderParams() {
		...
		Fields[11].fieldinfo(&aDT_INT, 44, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_INT, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_BYTE, 52, 8, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_INT, 56, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_INT, 60, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_INT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_INT, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		...
		Fields[21].fieldinfo(&aDT_INT, 84, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_INT, 88, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aRGBAColor, 92, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[25 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
RenderParams::~RenderParams() {
		free(Fields);
...
RenderPass::RenderPass() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aRenderParams, 8, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 104, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FIXEDARRAY, 108, 0, 0, 0, 0, 1, &aTextureStageParams, 16);
		Fields[5].fieldinfo(&aDT_INT, 428, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_CHARARRAY, 432, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[7].fieldinfo(&aDT_CHARARRAY, 688, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[8].fieldinfo(&aDT_CHARARRAY, 752, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[9].fieldinfo(&aSerializeData, 816, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_TAGMAP, 824, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
RenderPass::~RenderPass() {
		free(Fields);
...
Shaders::Shaders() {
		...
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aSerializeData, 20, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 1, &aRenderPass, -1);
		Fields[4].fieldinfo(&aDT_CHARARRAY, 32, 9, 0, 0, 0, 0, &aDT_NULL, 256);
		Fields[6 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Shaders::~Shaders() {
		free(Fields);
...
Anim2DFrame::Anim2DFrame() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[1].fieldinfo(&aRGBAColor, 64, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Anim2DFrame::~Anim2DFrame() {
		free(Fields);
...
Anim2D::Anim2D() {
		...
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aFrameAnim, 20, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_SNO, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 44, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aSerializeData, 48, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_VARIABLEARRAY, 56, 0, 0, 0, 0, 1, &aAnim2DFrame, -1);
		Fields[8 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Anim2D::~Anim2D() {
		free(Fields);
...
Font::Font() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 16, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[2].fieldinfo(&aDT_CHARARRAY, 80, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[3].fieldinfo(&aDT_INT, 144, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_ENUM, 148, 2, 0, 0, 2, 17, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_ENUM, 152, 2, 0, 0, 3, 17, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_INT, 156, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 160, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aSerializeData, 164, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_VARIABLEARRAY, 172, 0, 0, 0, 0, 0, &aDT_BYTE, -1);
		Fields[10].fieldinfo(&aDT_INT, 176, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Font::~Font() {
		free(Fields);
...
EmitterParams::EmitterParams() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aFloatPath, 4, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aFloatPath, 44, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aVectorPath, 84, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_CHARARRAY, 124, 8, 0, 0, 0, 1, &aDT_NULL, 128);
		Fields[6 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
EmitterParams::~EmitterParams() {
		free(Fields);
...
Particle::Particle() {
		...
		Fields[2].fieldinfo(&aDT_TIME, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_TIME, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_TIME, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aInterpolationScalar, 32, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aFloatPath, 44, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aIntPath, 84, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aFloatPath, 124, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aTimePath, 164, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aFloatPath, 204, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aVelocityVectorPath, 284, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aAnglePath, 244, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aVelocityVectorPath, 324, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aVelocityPath, 364, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aVelocityPath, 404, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aVelocityPath, 444, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aUberMaterial, 568, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_SNO, 672, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_MASS, 676, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_INT, 680, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_FLOAT, 684, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_FLOAT, 688, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_FLOAT, 692, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aDT_FLOAT, 696, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[25].fieldinfo(&aDT_FLOAT, 700, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26].fieldinfo(&aDT_FLOAT, 704, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[27].fieldinfo(&aDT_FLOAT, 708, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[28].fieldinfo(&aDT_SNO, 712, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[29].fieldinfo(&aEmitterParams, 716, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[30].fieldinfo(&aFloatPath, 1008, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[31].fieldinfo(&aColorPath, 968, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[32].fieldinfo(&aFloatPath, 1048, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[33].fieldinfo(&aFloatPath, 1088, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[34].fieldinfo(&aAnglePath, 1128, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[35].fieldinfo(&aAngularVelocityPath, 1168, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[36].fieldinfo(&aAngularVelocityPath, 1208, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[37].fieldinfo(&aAnglePath, 1248, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[38].fieldinfo(&aVectorPath, 1288, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[39].fieldinfo(&aFloatPath, 1328, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[40].fieldinfo(&aVelocityPath, 1368, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[41].fieldinfo(&aAngularVelocityPath, 1408, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[42].fieldinfo(&aFloatPath, 1448, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[43].fieldinfo(&aVelocityPath, 1488, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[44].fieldinfo(&aVectorPath, 1528, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[45].fieldinfo(&aVelocityVectorPath, 1568, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[46].fieldinfo(&aAccelVectorPath, 1608, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[47].fieldinfo(&aVectorPath, 1648, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[48].fieldinfo(&aVelocityVectorPath, 1688, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[49].fieldinfo(&aAccelVectorPath, 1728, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[50].fieldinfo(&aVelocityPath, 1768, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[51].fieldinfo(&aFloatPath, 1808, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[52].fieldinfo(&aVectorPath, 484, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[53].fieldinfo(&aVelocityPath, 524, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[54].fieldinfo(&aDT_FLOAT, 564, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[55].fieldinfo(&aDT_INT, 1848, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[56].fieldinfo(&aDT_FLOAT, 1852, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[57].fieldinfo(&aDT_FLOAT, 1856, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[58].fieldinfo(&aDT_INT, 1868, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[59].fieldinfo(&aSerializeData, 1860, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[60].fieldinfo(&aDT_VARIABLEARRAY, 1872, 0, 0, 0, 0, 1, &aMsgTriggeredEvent, -1);
		Fields[62 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Particle::~Particle() {
		free(Fields);
}
...
Trail::Trail() {
		...
		Fields[3].fieldinfo(&aDT_TIME, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_TIME, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_TIME, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_TIME, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aColorPath, 40, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aColorPath, 80, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aFloatPath, 120, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aFloatPath, 160, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_ENUM, 200, 2, 0, 0, 2, 17, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_INT, 204, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aUberMaterial, 208, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Trail::~Trail() {
		free(Fields);
...
Cloth::Cloth() {
		...
		Fields[3].fieldinfo(&aDT_FLOAT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FLOAT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FLOAT, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_FLOAT, 44, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_ACCEL, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLOAT, 52, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 56, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_FLOAT, 60, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_FIXEDARRAY, 64, 32, 0, 0, 0, 1, &aDT_INT, 4);
		Fields[14].fieldinfo(&aDT_SNO, 80, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Cloth::~Cloth() {
		free(Fields);
...
EffectItem::EffectItem() {
		...
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 4, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[2].fieldinfo(&aMsgTriggeredEvent, 68, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
EffectItem::~EffectItem() {
		free(Fields);
...
EffectGroup::EffectGroup() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_SNO, 44, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aSerializeData, 16, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 1, &aEffectItem, -1);
		Fields[9 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
EffectGroup::~EffectGroup() {
		free(Fields);
...
Surface::Surface() {
		...
		Fields[2].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aSerializeData, 24, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_TAGMAP, 32, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Surface::~Surface() {
		free(Fields);
...
Explosion::Explosion() {
		...
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aVector3D, 20, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_IMPULSE, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 36, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FLOAT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_FLOAT, 44, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_INT, 52, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 56, 32, 0, 0, 0, 1, &aDT_NULL, -1);
...
Physics::Physics() {
		...
		Fields[4].fieldinfo(&aDT_FLOAT, 28, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FLOAT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_WORD, 36, 16, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_FLOAT, 40, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_ACCEL, 44, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_ACCEL, 48, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_VELOCITY, 52, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_ACCEL, 56, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_ACCEL, 60, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Physics::~Physics() {
		free(Fields);
...
AmbientSound::AmbientSound() {
		...
		Fields[0].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_SNO, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FIXEDARRAY, 20, 0, 0, 0, 0, 1, &aRandomAmbientSoundParams, 2);
		Fields[3].fieldinfo(&aDT_SNO, 60, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_TIME, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_TIME, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_CHARARRAY, 72, 7, 0, 0, 0, 1, &aDT_NULL, 64);
		Fields[7].fieldinfo(&aDT_FLOAT, 136, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_FLOAT, 140, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 144, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_FLOAT, 148, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_FLOAT, 152, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AmbientSound::~AmbientSound() {
		free(Fields);
...
ImageFileID::ImageFileID() {
		...
		Fields[0].fieldinfo(&aDT_CHARARRAY, 0, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[1].fieldinfo(&aDT_CHARARRAY, 256, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[2].fieldinfo(&aDT_INT, 512, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ImageFileID::~ImageFileID() {
		free(Fields);
...
Textures::Textures() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 16, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_INT, 20, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_INT, 24, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 28, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_INT, 36, 32, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FIXEDARRAY, 40, 0, 0, 0, 0, 0, &aSerializeData, 60);
		Fields[6].fieldinfo(&aDT_INT, 520, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_INT, 32, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_CHARARRAY, 592, 9, 0, 0, 0, 1, &aDT_NULL, 256);
		Fields[9].fieldinfo(&aSerializeData, 852, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_VARIABLEARRAY, 848, 0, 0, 0, 0, 1, &aImageFileID, -1);
		Fields[11].fieldinfo(&aSerializeData, 524, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_VARIABLEARRAY, 532, 0, 0, 0, 0, 1, &aTexFrame, -1);
		Fields[13].fieldinfo(&aIVector2D, 536, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_INT, 860, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_INT, 864, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_INT, 868, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_INT, 544, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_INT, 548, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_INT, 552, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_INT64, 560, 64, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_INT, 568, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_BYTE, 572, 8, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aDT_BYTE, 573, 8, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aDT_BYTE, 574, 8, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Textures::~Textures() {
		free(Fields);
}
...
Material_1::Material_1() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 7);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aRGBAColorValue, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aRGBAColorValue, 16, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aRGBAColorValue, 32, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aRGBAColorValue, 48, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_INT, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
Material_1::~Material_1() {
		free(Fields);
...
MaterialTexture::MaterialTexture() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_SNO, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aTexAnimParams, 4, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
MaterialTexture::~MaterialTexture() {
		free(Fields);
...
MaterialTextureEntry::MaterialTextureEntry() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aMaterialTexture, 4, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
MaterialTextureEntry::~MaterialTextureEntry() {
		free(Fields);
...
UberMaterial::UberMaterial() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 5);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aMaterial_1, 4, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_SNO, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aSerializeData, 76, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_VARIABLEARRAY, 88, 0, 0, 0, 0, 33, &aMaterialTextureEntry, -1);
		Fields[5 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
UberMaterial::~UberMaterial() {
		free(Fields);
...
TexFrame::TexFrame() {
		...
		Fields[1].fieldinfo(&aDT_FLOAT, 64, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_FLOAT, 72, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_FLOAT, 76, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
TexFrame::~TexFrame() {
		free(Fields);
...
TexAnimParams::TexAnimParams() {
		...
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_INT, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aMatrix4x4, 4, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 68, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_VELOCITY, 72, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aDT_VELOCITY, 80, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[5].fieldinfo(&aDT_FLOAT, 76, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6].fieldinfo(&aDT_ANGLE, 84, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[7].fieldinfo(&aDT_ANGULARVELOCITY, 88, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[8].fieldinfo(&aDT_ANGLE, 92, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[9].fieldinfo(&aDT_FLOAT, 96, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[10].fieldinfo(&aDT_VELOCITY, 100, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[11].fieldinfo(&aDT_VELOCITY, 108, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[12].fieldinfo(&aDT_FLOAT, 104, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[13].fieldinfo(&aDT_ANGLE, 112, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[14].fieldinfo(&aDT_ANGULARVELOCITY, 116, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[15].fieldinfo(&aDT_ANGLE, 120, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[16].fieldinfo(&aDT_ANGLE, 124, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[17].fieldinfo(&aDT_ANGULARVELOCITY, 128, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[18].fieldinfo(&aDT_ANGULARVELOCITY, 132, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[19].fieldinfo(&aDT_INT, 136, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[20].fieldinfo(&aDT_INT, 140, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[21].fieldinfo(&aDT_INT, 144, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[22].fieldinfo(&aDT_INT, 148, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[23].fieldinfo(&aFrameAnim, 152, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[24].fieldinfo(&aDT_INT, 172, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[26 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
TexAnimParams::~TexAnimParams() {
		free(Fields);
...
InterpolationPathHeader::InterpolationPathHeader() {
		...
		Fields[2].fieldinfo(&aDT_FLOAT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[3].fieldinfo(&aDT_INT, 12, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4].fieldinfo(&aInterpolationScalar, 16, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[6 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
InterpolationPathHeader::~InterpolationPathHeader() {
		free(Fields);
...
FloatPath::FloatPath() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aInterpolationPathHeader, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 1, &aFloatNode, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
FloatPath::~FloatPath() {
		free(Fields);
...
IntPath::IntPath() {
		...
		Fields[0].fieldinfo(&aInterpolationPathHeader, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 1, &aIntNode, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
IntPath::~IntPath() {
		free(Fields);
...
VectorPath::VectorPath() {
		...
		Fields[0].fieldinfo(&aInterpolationPathHeader, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 1, &aVectorNode, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
VectorPath::~VectorPath() {
		free(Fields);
...
ColorPath::ColorPath() {
		...
		Fields[0].fieldinfo(&aInterpolationPathHeader, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 1, &aColorNode, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
ColorPath::~ColorPath() {
		free(Fields);
...
AngleNode::AngleNode() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_ANGLE, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_ANGLE, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AngleNode::~AngleNode() {
...
AnglePath::AnglePath() {
		...
		Fields[0].fieldinfo(&aInterpolationPathHeader, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 1, &aAngleNode, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AnglePath::~AnglePath() {
		free(Fields);
...
TimeNode::TimeNode() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_TIME, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_TIME, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
...
TimePath::TimePath() {
		...
		Fields[0].fieldinfo(&aInterpolationPathHeader, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 1, &aTimeNode, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
TimePath::~TimePath() {
		free(Fields);
...
VelocityPath::VelocityPath() {
		...
		Fields[0].fieldinfo(&aInterpolationPathHeader, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 1, &aVelocityNode, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
VelocityPath::~VelocityPath() {
		free(Fields);
...
AccelPath::AccelPath() {
		...
		Fields[0].fieldinfo(&aInterpolationPathHeader, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 1, &aAccelNode, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AccelPath::~AccelPath() {
		free(Fields);
...
VelocityVectorNode::VelocityVectorNode() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aVelocityVector3D, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aVelocityVector3D, 12, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
VelocityVectorNode::~VelocityVectorNode() {
...
VelocityVectorPath::VelocityVectorPath() {
		...
		Fields[0].fieldinfo(&aInterpolationPathHeader, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 1, &aVelocityVectorNode, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
VelocityVectorPath::~VelocityVectorPath() {
		free(Fields);
...
AccelVectorNode::AccelVectorNode() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aAccelVector3D, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aAccelVector3D, 12, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 24, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AccelVectorNode::~AccelVectorNode() {
...
AccelVectorPath::AccelVectorPath() {
		...
		Fields[0].fieldinfo(&aInterpolationPathHeader, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 1, &aAccelVectorNode, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AccelVectorPath::~AccelVectorPath() {
		free(Fields);
...
AngularVelocityNode::AngularVelocityNode() {
		Fields = (FieldInfo*) malloc(sizeof(FieldInfo) * 4);
		cout << "initializing Fields " << endl;
		Fields[0].fieldinfo(&aDT_ANGULARVELOCITY, 0, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aDT_ANGULARVELOCITY, 4, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_FLOAT, 8, 32, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AngularVelocityNode::~AngularVelocityNode() {
...
AngularVelocityPath::AngularVelocityPath() {
		...
		Fields[0].fieldinfo(&aInterpolationPathHeader, 0, 0, 0, 0, 0, 1, &aDT_NULL, -1);
		Fields[1].fieldinfo(&aSerializeData, 32, 0, 0, 0, 0, 0, &aDT_NULL, -1);
		Fields[2].fieldinfo(&aDT_VARIABLEARRAY, 28, 0, 0, 0, 0, 1, &aAngularVelocityNode, -1);
		Fields[4 - 1].fieldinfo(NULL, 0, 0, 0, 0, 0, 0, NULL,0);
	}
AngularVelocityPath::~AngularVelocityPath() {
		free(Fields);
